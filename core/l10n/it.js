OC.L10N.register(
    ...
    "Skip" : "Salta",
    "Installing apps …" : "Installazione app …",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Accedi prima di accordare a \"{client}\" l'accesso al tuo account {instanceName}.",
    ...
    "Log in using password" : "Accedi utilizzando la password",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Attualmente connesso come {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Stai per accordare a \"{client}\" l'accesso al tuo account {instanceName}.",
    ...
    "If this happens again, please send the technical details below to the server administrator." : "Se ciò si verifica nuovamente, invia i seguenti dettagli tecnici all'amministratore del server.",
