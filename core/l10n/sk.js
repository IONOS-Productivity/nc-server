OC.L10N.register(
    ...
    "Search connected services" : "Vyhľadávať pripojené služby",
    "Results" : "Výsledky",
    ...
    "Security warning" : "Bezpečnostné varovanie",
    "Create administration account" : "Vytvoriť účet administrátora",
    "Administration account name" : "Názov účtu administrátora",
    "Administration account password" : "Heslo účtu administrátora",
    "Storage & database" : "Úložisko & databáza",
    "Data folder" : "Priečinok dát",
    "Database configuration" : "Konfigurácia Databáze",
    "Only {firstAndOnlyDatabase} is available." : "Je dostupná iba {firstAndOnlyDatabase}",
    ...
    "Alternative log in using app password" : "Alternatívne prihlásenie pomocou hesla aplikácie",
    "Account access" : "Prístup k účtu",
    "Currently logged in as %1$s (%2$s)." : "Momentálne ste prihlásený ako %1$s (%2$s).",
