OC.L10N.register(
    ...
    "Filter by team" : "Nach Team filtern",
    "All teams" : "Alle Teams",
    "Search contacts in team {team}" : "Kontakte im Team {team} suchen",
    "Search contacts …" : "Kontakte suchen …",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Bitte anmelden, bevor Sie \"{client}\" Zugriff auf Ihr {instanceName}-Konto gewähren.",
    ...
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Sie sind dabei, \"{client}\" Zugriff auf Ihr {instanceName}-Konto zu gewähren.",
