OC.L10N.register(
    ...
    "State token missing" : "Недостасува безбедносен токен",
    ...
    "Input text is too long" : "Влезниот текст е премногу долг",
    ...
    "Date" : "Датум",
    "People" : "Луѓе",
    "Filter in current view" : "Филтрирај во тековниот приказ",
    "Search connected services" : "Пребарај во поврзаните сервиси",
    "Results" : "Резултати",
    ...
    "Loading apps …" : "Вчитување апликации …",
    ...
    "Skip" : "Прескокни",
    "Installing apps …" : "Инсталирање апликации …",
    ...
    "The Nextcloud login form is disabled. Use another login option if available or contact your administration." : "Формуларот за најавување на Nextcloud е оневозможен. Користете друга опција за најавување доколку е достапна или контактирајте ја вашата администрација.",
    "Connect to your account" : "Поврзани со вашата сметка",
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Најави се пред да му овозможиш на \"{client}\" да пристапи до твојата {instanceName} сметка.",
    ...
    "Log in using password" : "Најви се со лозинка",
    "Alternative log in using app password" : "Алтернативен начин на најава со користење на лозинка за апликација",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Моментално сте најавени како {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Ќе му овозможите пристап на \"{client}\" да пристапи на вашата {instanceName} сметка.",
