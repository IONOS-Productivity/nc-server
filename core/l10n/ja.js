OC.L10N.register(
    ...
    "The account limit of this instance is reached." : "このインスタンスのアカウント制限に達しました。",
    ...
    "Password is strong" : "パスワードは強力です",
    "Password is very strong" : "パスワードは非常に強力です",
    "Password is extremely strong" : "パスワードは極めて強力です",
    "Unknown password strength" : "パスワード強度が不明です",
    "Your data directory and files are probably accessible from the internet because the <code>.htaccess</code> file does not work." : "<code>.htaccess</code>ファイルが動作していないため、おそらくあなたのデータディレクトリまたはファイルはインターネットからアクセス可能になっています。",
    ...
    "Only {firstAndOnlyDatabase} is available." : "{firstAndOnlyDatabase} のみ有効です。",
