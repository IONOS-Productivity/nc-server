OC.L10N.register(
    ...
    "Search connected services" : "搜索已连接的服务",
    "Results" : "结果",
    ...
    "All teams" : "所有团队",
    "Search contacts in team {team}" : "搜索团队 {team} 中的联系人",
    "Search contacts …" : "搜索联系人 …",
    "Reset search" : "重置搜索",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "请先登录，然后再授予“{client}”访问您的 {instanceName} 账号的权限。",
    ...
    "Account access" : "账号访问",
    "Currently logged in as {userDisplayName} ({userId})." : "当前登录身份 {userDisplayName}（{userId}）。.",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "您即将授予“{client}访问您的 {instanceName} 账号的权限。",
    "More actions" : "更多操作 ",
