OC.L10N.register(
    ...
    "The selected file is not an image." : "არჩეული ფაილი არ არის სურათი.",
    "The selected file cannot be read." : "არჩეული ფაილი ვერ იკითხება.",
    ...
    "No image or file provided" : "სურათი ან ფაილი არ არის მითითებული",
    ...
    "Login" : "Login",
    "Unsupported email length (>255)" : "იმეილი ძალიან გრძელია (>255)",
    ...
    "The given provider is not available" : "მოცემული პროვაიდერი მიუწვდომელია",
    ...
    "Login or email" : "მომხმარებელის სახელი ან იმეილი",
    ...
    "_Please enter {minSearchLength} character or more to search_::_Please enter {minSearchLength} characters or more to search_" : ["Please enter {minSearchLength} character or more to search","გთხოვთ, შეიყვანოთ {minSearchLength} ან მეტი ასო ძიებისთვის"],
    ...
    "Password is average" : "პაროლი დამაკმაყოფილებელია",
