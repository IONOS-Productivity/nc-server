OC.L10N.register(
    ...
    "Search connected services" : "Hledat připojené služby",
    "Results" : "Výsledky",
    ...
    "Filter by team" : "Filtrovat podle týmu",
    "All teams" : "Všechny týmy",
    "Search contacts in team {team}" : "Hledat kontakty v týmu {team}",
    "Search contacts …" : "Hledat v kontaktech …",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Přihlaste se abyste mohli „{client}“ udělit přístup ke svému {instanceName} účtu.",
    ...
    "Log in using password" : "Přihlásit s heslem",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Nyní jste přihlášeni jako {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Chystáte se povolit {client} přístup k vašemu {instanceName} účtu.",
