OC.L10N.register(
    ...
    "The account limit of this instance is reached." : "De accountlimiet van deze instantie is bereikt.",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Gelieve eerst inloggen voordat je \"{client}\" toegang geeft tot je {instanceName} account.",
    ...
    "Log in using password" : "Inloggen met wachtwoord",
    "Alternative log in using app password" : "Alternatieve login met app wachtwoord",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Momenteel ingelogd als {userDisplayName} ({userId})",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Je staat op het punt om \"{client}\" toegang te geven tot je {instanceName} account.",
    ...
    "Email length is at max (255)" : "E-maillengte is op maximum (255)",
    "Clipboard not available, please copy manually" : "Klembord niet beschikbaar, kopieer handmatig a.u.b.",
    ...
    "For more details see the documentation ↗." : "Voor meer details zie de documentatie ↗.",
