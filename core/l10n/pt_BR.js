OC.L10N.register(
    ...
    "%s password reset" : "%s redefinição da senha",
    ...
    "Failed to add the public link to your Nextcloud" : "Falha ao adicionar o link público ao seu Nextcloud",
    ...
    "Search connected services" : "Pesquisar serviços conectados",
    "Results" : "Resultados",
    ...
    "It appears your session token has expired, please refresh the page and try again." : "Parece que seu token de sessão expirou. Atualize a página e tente novamente.",
    ...
    "Filter by team" : "Filtrar por equipe",
    "All teams" : "Todas as equipes",
    "Search contacts in team {team}" : "Pesquisar contatos na equipe {team}",
    "Search contacts …" : "Pesquisar contatos …",
    ...
    "Close \"{dialogTitle}\" dialog" : "Fechar a caixa de diálogo \"{dialogTitle}\"",
