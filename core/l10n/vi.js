OC.L10N.register(
    ...
    "Please use original client" : "Vui lòng sử dụng ứng dụng gốc",
    ...
    "Input text is too long" : "Văn bản nhập quá dài",
    ...
    "Filter by team" : "Lọc theo nhóm",
    "All teams" : "Tất cả nhóm",
    "Search contacts in team {team}" : "Tìm kiếm liên hệ trong nhóm {team}",
    "Search contacts …" : "Tìm kiếm liên hệ …",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Vui lòng đăng nhập để cấp quyền cho \"{client}\" truy cập {instanceName} của bạn.",
    ...
    "Log in using password" : "Đăng nhập bằng mật khẩu",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Tài khoản: {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Hành động này sẽ cho phép \"{client}\" truy cập tải khoản {instanceName} của bạn.",
