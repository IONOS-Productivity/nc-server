OC.L10N.register(
    ...
    "Plain text document" : "Düz yazı belgesi",
    "Rich Text document" : "Zengin yazı belgesi",
    ...
    "Direct link copied" : "Doğrudan bağlantı kopyalandı",
    ...
    "Search connected services" : "Bağlı aygıtları ara",
    "Results" : "Sonuçlar",
    ...
    "Collaborative documents, spreadsheets and presentations, built on Collabora Online." : "Collabora Online üzerinde hazırlanmış iş birlikli belgeler, çalışma sayfaları ve sunumlar.",
    ...
    "Filter by team" : "Takıma göre süz",
    "All teams" : "Tüm takımlar",
    "Search contacts in team {team}" : "{team} takımındaki kişileri ara",
    "Search contacts …" : "Kişi arama…",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Lütfen \"{client}\" erişim iznini {instanceName} hesabınıza vermeden önce oturum açın.",
    ...
    "Log in using password" : "Parola ile oturum aç",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "{userDisplayName} ({userId}) olarak oturum açıldı.",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "\"{client}\" erişim iznini {instanceName} hesabınıza vermek üzeresiniz.",
    ...
    "The update completed with warnings. Please check the details for more information." : "Güncelleme bazı uyarılar ile tamamlandı. Ayrıntılı bilgi almak için ayrıntılara bakın.",
    "The update completed successfully." : "Güncelleme tamamlandı.",
    "Preparing update…" : "Güncelleme hazırlanıyor…",
    "You will be redirected to {productName} in {count} seconds." : "{count} saniye sonra {productName} üzerine yönlendirileceksiniz.",
    ...
    "{productName} will be updated to version {version}" : "{productName}, {version} sürümüne güncellenecek",
    "The theme {oldTheme} has been disabled." : "{oldTheme} teması kullanımdan kaldırıldı.",
    "These incompatible apps will be disabled:" : "Şu uyumsuz uygulamalar kullanımdan kaldırılacak:",
    "Incompatible apps" : "Uyumsuz uygulamalar",
    "These apps will be updated:" : "Şu uygulamalar güncellenecek:",
    "Apps to update" : "Güncellenecek uygulamalar",
    "{app} from {oldVersion} to {version}" : "{app}, {oldVersion} sürümünden {version} sürümüne",
    ...
    "Clipboard not available, please copy manually" : "Pano kullanılamıyor. Lütfen el ile kopyalayın",
    "Personal" : "Kişisel",
    "Accounts" : "Hesaplar",
    "Admin" : "Yönetici",
    "Help" : "Yardım",
