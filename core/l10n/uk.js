OC.L10N.register(
    ...
    "Your files are encrypted. There will be no way to get your data back after your password is reset. If you are not sure what to do, please contact your administrator before you continue. Do you really want to continue?" : "Ваші файли зашифровано. У разі перевстановлення пароля ви не зможете отримати доступ до них. Якщо ви не впевнені, що робити, будь ласка, сконтактуйте з адміністратором перед продовженням. Дійсно продовжити?",
    ...
    "Filter by team" : "Фільтр за командою",
    "All teams" : "Всі команди",
    "Search contacts in team {team}" : "Шукати контакти в команді {team}",
    ...
    "More details can be found in the server log." : "Більше деталей може бути в журналі сервера.",
    ...
    "This page will refresh itself when the instance is available again." : "Сторінка оновиться автоматично, щойно сервер знову стане доступний.",
