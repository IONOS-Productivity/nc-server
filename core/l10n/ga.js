OC.L10N.register(
    ...
    "Search connected services" : "Cuardaigh seirbhísí nasctha",
    "Results" : "Torthaí",
    ...
    "Filter by team" : "Scag de réir foirne",
    "All teams" : "Gach foireann",
    "Search contacts in team {team}" : "Cuardaigh teagmhálaithe i bhfoireann {team}",
    "Search contacts …" : "Cuardaigh teagmhálaithe …",
    ...
    "Contacts list" : "Liosta teagmhálaithe",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Logáil isteach le do thoil sula dtugann tú rochtain do \"{client}\" ar do chuntas {instanceName}.",
    ...
    "Log in using password" : "Logáil isteach ag baint úsáide as pasfhocal",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Logáilte isteach faoi láthair mar {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Tá tú ar tí rochtain a dheonú do \"{client}\" ar do chuntas {instanceName}.",
