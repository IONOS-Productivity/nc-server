OC.L10N.register(
    ...
    "Input text is too long" : "Wprowadzony tekst jest zbyt długi",
    ...
    "Cannot generate more than 12 images" : "Nie można wygenerować więcej niż 12 obrazów",
    "Cannot generate less than 1 image" : "Nie można wygenerować mniej niż 1 obraz",
    ...
    "Search connected services" : "Szukaj połączonych usług",
    "Results" : "Wyniki",
    ...
    "Filter by team" : "Filtruj według zespołu",
    "All teams" : "Wszystkie zespoły",
    "Search contacts in team {team}" : "Szukaj kontaktów w zespole {team}",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Zaloguj się, zanim przyznasz klientowi \"{client}\" dostęp do konta {instanceName}.",
    ...
    "Log in using password" : "Zaloguj się przy użyciu hasła",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Aktualnie zalogowany jako {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Zamierzasz przyznać klientowi \"{client}\" dostęp do konta {instanceName}.",
