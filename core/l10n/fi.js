OC.L10N.register(
    ...
    "Please use original client" : "Käytä alkuperäistä asiakasohjelmistoa",
    ...
    "Zstandard archive" : "Zstandard-arkisto",
    "AAC audio" : "AAC-ääni",
    ...
    "Direct link copied" : "Suora linkki kopioitu",
    ...
    "Search in date range" : "Etsi aikaväliltä",
    ...
    "Between {startDate} and {endDate}" : "Välillä {startDate} ja {endDate}",
    ...
    "Session error" : "Istuntovirhe",
    "It appears your session token has expired, please refresh the page and try again." : "Vaikuttaa siltä, että istunnon poletti vanheni. Päivitä sivu ja yritä uudelleen.",
    ...
    "Chatting, video calls, screen sharing, online meetings and web conferencing – in your browser and with mobile apps." : "Keskustelu, videopuhelut, näytön jako, verkkotapaamiset ja web-konferenssit – selaimessasi ja puhelinsovelluksilla.",
    ...
    "Filter by team" : "Suodata tiimin perusteella",
    ...
    "Log in using password" : "Kirjaudu sisään salasanalla",
    ...
    "Password is strong" : "Salasana on vahva",
    ...
    "The update completed with warnings. Please check the details for more information." : "Päivitys valmistui varoitusten kera. Tarkista yksityiskohdat saadaksesi lisätietoja.",
    "The update completed successfully." : "Päivitys valmistui onnistuneesti.",
    "Preparing update…" : "Valmistellaan päivitystä…",
    ...
    "{productName} will be updated to version {version}" : "{productName} päivitetään versioon {version}",
    "The theme {oldTheme} has been disabled." : "Teema {oldTheme} on poistettu käytöstä.",
    "These incompatible apps will be disabled:" : "Nämä yhteensopimattomat sovellukset poistetaan käytöstä:",
    "Incompatible apps" : "Yhteensopimattomia sovelluksia",
    "These apps will be updated:" : "Nämä sovellukset päivitetään:",
    "Apps to update" : "Päivitettävät sovellukset",
    "{app} from {oldVersion} to {version}" : "{app} versiosta {oldVersion} versioon {version}",
    ...
    "Update details" : "Päivityksen tiedot",
