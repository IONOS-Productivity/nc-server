OC.L10N.register(
    ...
    "Search connected services" : "Поиск подключенных сервисов",
    "Results" : "Результаты",
    ...
    "Filter by team" : "Отбор по команде",
    "All teams" : "Все команды",
    "Search contacts in team {team}" : "Поиск контактов в команде {team}",
    "Search contacts …" : "Поиск контактов …",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Для предоставления {client} доступа к своей учётной записи {instanceName} необходимо войти в систему.",
    ...
    "Log in using password" : "Войти по паролю",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Вход в систему выполнен под именем {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Вы предоставляете «{client}» доступ к своей учётной записи {instanceName}.",
