OC.L10N.register(
    ...
    "Please use original client" : "Utilice o cliente orixinal",
    "This community release of Nextcloud is unsupported and push notifications are limited." : "Esta edición comunitaria de Nextcloud non é compatíbel e as notificacións emerxentes son limitadas.",
    "Login" : "Acceder",
    ...
    "Node is locked" : "O nodo está bloqueado",
    ...
    "user@your-nextcloud.org" : "usuario@o-seu-nextcloud.org",
    "Create share" : "Crear compartición",
    "Direct link copied to clipboard" : "A ligazón directa foi copiada no portapapeis",
    "Please copy the link manually:" : "Copie a ligazón manualmente:",
    ...
    "Search connected services" : "Buscar servizos conectados",
    "Results" : "Resultados",
    ...
    "Filter by team" : "Filtrar polo equipo",
    "All teams" : "Todos os equipos",
    "Search contacts in team {team}" : "Buscar contactos no equipo {team}",
    "Search contacts …" : "Buscar contactos…",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Acceda antes de concederlle a «{client}» acceso á súa conta en {instanceName}.",
    ...
    "Log in using password" : "Acceder empregando contrasinal",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Agora está conectado como {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Está a piques de concederlle a «{client}» acceso á a súa conta en {instanceName}.",
