OC.L10N.register(
    ...
    "PHP with a version lower than %s is required." : "Se requiere una versión de PHP inferior a %s.",
    ...
    "Server version %s or higher is required." : "Se requiere la versión %s o superior del servidor.",
    "Server version %s or lower is required." : "Se requiere la versión %s o inferior del servidor.",
    ...
    "Wiping of device %s has started" : "La limpieza del dispositivo %s ha iniciado",
    "Wiping of device »%s« has started" : "La limpieza del dispositivo »%s« ha iniciado",
    "»%s« started remote wipe" : "»%s« ha iniciado la limpieza remota",
    "Device or application »%s« has started the remote wipe process. You will receive another email once the process has finished" : "El dispositivo o la aplicación »%s« ha iniciado el proceso de limpieza remoto. Recibirá otro mensaje por correo electrónico una vez que el proceso haya finalizado.",
    "Wiping of device %s has finished" : "La limpieza del dispositivo %s ha finalizado",
    "Wiping of device »%s« has finished" : "La limpieza del dispositivo »%s« ha finalizado",
    "»%s« finished remote wipe" : "»%s« finalizó la limpieza remota",
    ...
    "Remote wipe started" : "Limpieza remota iniciada.",
    "A remote wipe was started on device %s" : "Se ha iniciado una limpieza remota en el dispositivo %s",
    "Remote wipe finished" : "Limpieza remota finalizada",
    ...
    "Empty filename is not allowed" : "No está permitido un nombre de archivo en blanco",
    "App \"%s\" cannot be installed because appinfo file cannot be read." : "No se puede instalar la app \"%s\" debido a que no se puede leer el archivo appinfo.",
    "App \"%s\" cannot be installed because it is not compatible with this version of the server." : "No se puede instalar la aplicación \"%s\" debido a que no es compatible con esta versión del servidor.",
    ...
    "You cannot share a folder that contains other shares" : "No puede compartir una carpeta que contiene otros recursos compartidos",
    ...
    "Generate a headline" : "Generar un título",
    "Generates a possible headline for a text." : "Genera un posible título para un texto.",
    ...
    "Generate headline" : "Generar título",
