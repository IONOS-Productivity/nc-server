OC.L10N.register(
    ...
    "No file conversion providers available" : "ファイル変換プロバイダーは利用できません",
    "File is too large to convert" : "ファイルが大きすぎて変換できません",
    ...
    "Accounts" : "アカウント",
    "Bluesky" : "Bluesky",
    "View %s on Bluesky" : "Blueskyで%sを表示",
    "Email" : "メール",
    "Mail %s" : "メール %s",
    "Fediverse" : "フェディバース",
    ...
    "File shares cannot have create or delete permissions" : "ファイル共有に作成または削除の権限を設定することはできません",
    ...
    "You cannot share a folder that contains other shares" : "他の共有を含むフォルダーを共有することはできません",
    ...
    "Question" : "質問",
    "What to ask about the images." : "画像について質問する。",
