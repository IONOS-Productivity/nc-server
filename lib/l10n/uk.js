OC.L10N.register(
    ...
    "This can usually be fixed by giving the web server write access to the config directory." : "Зазвичай це можна виправити шляхом надання вебсерверу доступу на запису до каталогу конфігурації.",
    ...
    "Cannot enable sending the password by Talk with an empty password" : "Не вдалося увімкнути надсилання пароля за допомогою Talk з порожнім паролем",
    "Cannot enable sending the password by Talk without setting a new password" : "Не вдалося увімкнути надсилання пароля за допомогою Talk без встановлення нового пароля",
    "Cannot disable sending the password by Talk without setting a new password" : "Не вдалося вимкнути надсилання пароля за допомогою Talk без встановлення нового пароля",
    ...
    "This can usually be fixed by giving the web server write access to the config directory. See %s" : "Зазвичай це можна виправити шляхом надання вебсерверу доступу на запису до каталогу конфігурації. Докладно %s",
    ...
    "This can usually be fixed by giving the web server write access to the root directory. See %s" : "Зазвичай це можна виправити шляхом надання вебсерверу доступу на запис до кореневого каталогу. Докладно %s",
    "Permissions can usually be fixed by giving the web server write access to the root directory. See %s." : "Дозволи зазвичай можна виправити шляхом надання вебсерверу доступу на запис до кореневого каталогу. Докладно %s. ",
