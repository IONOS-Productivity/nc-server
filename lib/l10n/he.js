OC.L10N.register(
    ...
    "_in %n month_::_in %n months_" : ["בעוד חודש","בעוד חודשיים","בעוד %n חודשים"],
    "_%n month ago_::_%n months ago_" : ["לפני חודש","לפני חודשיים","לפני %n חודשים"],
    "next year" : "בשנה הבאה",
    "last year" : "שנה שעברה",
    ...
    "Filename contains at least one invalid character" : "שם הקובץ מכיל לפחות תו אחד שגוי",
