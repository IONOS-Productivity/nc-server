OC.L10N.register(
    ...
    "Moving a share (%s) into a shared folder is not allowed" : "Non è permesso spostare una condivisone (%s) in una cartella condivisa ",
    "Moving a storage (%s) into a shared folder is not allowed" : "Non è permesso spostare un'archiviazione (%s) in una cartella condivisa",
    "Moving a share (%s) into another share (%s) is not allowed" : "Non è permesso spostare una condivisione (%s) in un'altra condivisione (%s)",
    "Moving a share (%s) into another storage (%s) is not allowed" : "Non è permesso spostare una condivisione (%s) in un'altra archivazione (%s)",
    "Moving a storage (%s) into a share (%s) is not allowed" : "Non è permesso spostare un'archiviazione (%s) in una condivisione (%s)",
    ...
    "Set an admin Login." : "Imposta un utente amministratore.",
    ...
    "Link sharing is not allowed" : "La condivisione via collegamento non è permessa",
    ...
    "Chat by voice with an agent" : "Chat con un agente tramite voce",
    ...
    "Extract text from files like images or PDFs" : "Estrai testo da file come immagini o PDF",
    ...
    "Chat" : "Chat",
    "Chat with the assistant" : "Chat con l'assistente",
    "The history of chat messages before the current message, starting with a message by the user" : "La cronologia dei messaggi di chat precedenti al messaggio corrente, a partire da un messaggio dell'utente",
    ...
    "Chat with the language model with tool calling support." : "Chat con il modello di linguaggio con supporto per la chiamata degli strumenti.",
