OC.L10N.register(
    ...
    "Accounts" : "Hesaplar",
    "Bluesky" : "Bluesky",
    "View %s on Bluesky" : "Bluesky üzerinde görüntüle: %s",
    "Email" : "E-posta",
    ...
    "Twitter" : "Twitter",
    "View %s on Twitter" : "Twitter üzerinde görüntüle: %s",
    "Website" : "Site",
    "Visit %s" : "Siteyi aç: %s",
    "Address" : "Adres",
    ...
    "macOS is not supported and %s will not work properly on this platform." : "macOS desteklenmiyor ve %s bu platformda düzgün çalışmayacak.",
    ...
    "A token representing the conversation." : "Görüşmenin kodu.",
    "The new conversation token" : "Yeni görüşme kodu",
    ...
    "Writes text in a given style based on the provided source material." : "Sağlanan kaynak materyale göre belirli bir tarzda yazı oluşturur.",
    ...
    "Generated text" : "Oluşturulan yazı",
    "The generated text with content from the source material in the given style" : "Kaynak materyal içeriği ile belirtilen tarzda oluşturulan yazı",
    "Emoji generator" : "Duygu ifadesi oluşturma",
    "Takes text and generates a representative emoji for it." : "Yazıyı alır ve onu temsil eden bir duygu ifadesi oluşturur.",
    ...
    "Extract text from files like images or PDFs" : "Görsel ya da PDF gibi dosyalardan yazı ayıkla",
    "Input files" : "Giriş dosyaları",
    "The files to extract text from" : "Yazının ayıklanacağı dosyalar",
    "Output texts" : "Çıkış yazıları",
    "The texts that were extracted from the files" : "Dosyalardan ayıklanan yazı",
    ...
    "The generated text from the assistant" : "Yardımcının oluşturduğu yazı",
    "Change Tone" : "Tonu değiştir",
    "Change the tone of a piece of text." : "Bir yazı parçasının tonunu değiştirir.",
    ...
    "The rewritten text in the desired tone, written by the assistant:" : "Yardımcı tarafından istenilen tonda yeniden oluşturulan yazı:",
    "Chat" : "Sohbet",
    "Chat with the assistant" : "Yardımcı ile sohbet et",
    "The history of chat messages before the current message, starting with a message by the user" : "Kullanıcının iletisiyle başlayarak, geçerli iletiden önceki sohbet iletilerinin geçmişi",
    "Response message" : "Yanıt iletisi",
    "The generated response as part of the conversation" : "Görüşmenin parçası olarak oluşturulan yanıt",
    ...
    "Formalize text" : "Yazıyı resmileştir",
    "Takes a text and makes it sound more formal" : "Bir yazıyı alarak daha resmi dile dönüştürür",
    "Write a text that you want the assistant to formalize" : "Yardımcının resmileştirmesini istediğiniz bir yazı yazın",
    "Formalized text" : "Resmileştirilmiş yazı",
    "The formalized text" : "Resmileştirilmiş yazı",
    "Generate a headline" : "Bir başlık oluştur",
    "Generates a possible headline for a text." : "Bir yazı için olası bir başlık oluşturur.",
    "Original text" : "Özgün yazı",
    "The original text to generate a headline for" : "Başlık oluşturulacak yazı",
    "The generated headline" : "Oluşturulan başlık",
    "Proofread" : "Düzelt",
    "Proofreads a text and lists corrections" : "Bir yazıyı düzeltir ve düzeltmeleri listeler",
    "Text" : "Yazı",
    "The text to proofread" : "Düzeltilecek yazı",
    "Corrections" : "Düzeltmeler",
    "The corrections that should be made in your text" : "Yazınızda yapılması gereken düzeltmeler",
    "Reformulate text" : "Yazıyı yeniden düzenle",
    "Takes a text and reformulates it" : "Bir yazıyı alarak yeniden düzenler",
    "Write a text that you want the assistant to reformulate" : "Yardımcının yeniden düzenlemesini istediğiniz bir yazı yazın",
    "Reformulated text" : "Yeniden düzenlenmiş yazı",
    "The reformulated text, written by the assistant" : "Yardımcı tarafından yazılan yeniden düzenlenmiş yazı",
    "Simplify text" : "Yazıyı basitleştir",
    "Takes a text and simplifies it" : "Bir yazıyı alarak basitleştirir",
    "Write a text that you want the assistant to simplify" : "Yardımcının basitleştirmesini istediğiniz bir yazı yazın",
    "Simplified text" : "Basitleştirilmiş yazı",
    "The simplified text" : "Basitleştirilmiş yazı",
    "Summarize" : "Özetlensin",
    "Summarizes a text" : "Bir yazıyı özetler",
    "The original text to summarize" : "Özetlenecek özgün yazı",
    "Summary" : "Özet",
    "The generated summary" : "Oluşturulan özet",
    "Extract topics" : "Başlıklar ayıklansın",
    "Extracts topics from a text and outputs them separated by commas" : "Bir yazıdaki konuları ayıklar ve bunları virgül ile ayırarak sıralar",
    "The original text to extract topics from" : "Konuların ayıklanacağı özgün yazı",
    "Topics" : "Konular",
    "The list of extracted topics" : "Ayıklanan konuların listesi",
    "Translate" : "Çevir",
    "Translate text from one language to another" : "Yazıyı bir dilden diğerine çevir",
    "Origin text" : "Kaynak yazı",
    "The text to translate" : "Çevrilecek yazı",
    "Origin language" : "Kaynak dil",
    "The language of the origin text" : "Kaynak yazının dili",
    "Target language" : "Hedef dil",
    "The desired language to translate the origin text in" : "Kaynak yazının çevrilmesini istediğiniz dil",
    "Result" : "Sonuç",
    "The translated text" : "Çevrilmiş yazı",
    ...
    "Summarizes text by reducing its length without losing key information." : "Temel içeriği kaybetmeden uzunluğunu kısaltarak yazıyı özetler.",
    "Extracts topics from a text and outputs them separated by commas." : "Bir yazıdaki konuları ayıklar ve bunları virgül ile ayırarak sıralar.",
