OC.L10N.register(
    ...
    "_%nm_::_%nm_" : ["%nm","%nm","%nm","%nm","%nm"],
    "%s ahead" : "%s romhainn",
    "%s behind" : "%s taobh thiar",
    ...
    "File shares cannot have create or delete permissions" : "Ní féidir ceadanna cruthaithe nó scriosta a bheith ag scaireanna comhaid",
    ...
    "You cannot share a folder that contains other shares" : "Ní féidir leat fillteán a roinnt ina bhfuil scaireanna eile",
    ...
    "Extract text from files like images or PDFs" : "Bain téacs as comhaid cosúil le híomhánna nó PDFanna",
    "Input files" : "Comhaid ionchuir",
    "The files to extract text from" : "Na comhaid le téacs a bhaint astu",
    "Output texts" : "Téacsanna aschuir",
    "The texts that were extracted from the files" : "Na téacsanna a baineadh as na comhaid",
