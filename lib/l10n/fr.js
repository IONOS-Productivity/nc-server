OC.L10N.register(
    ...
    "Invalid parent path" : "Chemin parent invalide",
    ...
    "Templates" : "Modèles",
    "Storage %s cannot be moved" : "L'emplacement de stockage %s ne peut être déplacé",
    ...
    "Filename is too long" : "Le nom de fichier est trop long",
    ...
    "Help & privacy" : "Aide & confidentialité",
    ...
    "Cannot share with yourself" : "Vous ne pouvez pas partager avec vous-même",
    ...
    "Chat voice message" : "Message vocal",
    ...
    "Tools call instructions from the model in JSON format" : "Instructions d'appel d'outil depuis le modèle au format JSON",
