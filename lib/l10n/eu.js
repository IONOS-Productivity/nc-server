OC.L10N.register(
    "lib",
    {
    "Cannot write into \"config\" directory!" : "Ezin da idatzi \"config\" direktorioan!",
    ...
    "No file conversion providers available" : "Ez dago bihurtze-hornitzailerik erabilgarri",
    "File is too large to convert" : "Fitxategia handiegia da bihurtzeko",
    "Destination does not match conversion extension" : "Helmuga ez dator bihurketa luzapenarekin",
    "Could not convert file" : "Ezin da fitxategia bihurtu",
    "Destination does not exist" : "Helmuga ez dago",
    "Destination is not creatable" : "Helmuga ezin da sortu",
    ...
    "Accounts" : "Kontuak",
    "Bluesky" : "Bluesky",
    "View %s on Bluesky" : "Ikusi %s Blueskyn",
    ...
    "File shares cannot have create or delete permissions" : "Fitxategien partekatzeek ezin dute baimenik sortu edo ezabatu",
    ...
    "Username is too long" : "Erabiltzaile-izena luzeegia da",
    ...
    "The history of chat messages before the current message, starting with a message by the user." : "Txat-mezuen historia uneko mezuaren aurretik, erabiltzailearen mezu batetik hasita.",
    ...
    "Extract text from files like images or PDFs" : "Erauzi testua irudiak edo PDFak bezalako fitxategietatik",
