OC.L10N.register(
    ...
    "No file conversion providers available" : "Ingen filkonverterare tillgänglig",
    "File is too large to convert" : "Filen är för stor för att konverteras",
    "Destination does not match conversion extension" : "Målet matchar inte konverteringsändelsen",
    "Could not convert file" : "Kunde inte konvertera filen",
    ...
    "Accounts" : "Konton",
    "Bluesky" : "Bluesky",
    "View %s on Bluesky" : "Se %s på Bluesky",
    "Email" : "E-post",
    ...
    "File shares cannot have create or delete permissions" : "Fildelningar kan inte ha behörighet att skapa eller radera",
    ...
    "You cannot share a folder that contains other shares" : "Du kan inte dela en mapp som innehåller andra delningar",
