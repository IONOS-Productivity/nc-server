OC.L10N.register(
    ...
    "%1$s and %2$s" : "%1$s ھەمدە %2$s",
    "%1$s, %2$s and %3$s" : "%1$s ۋە %2$s ھەمدە %3$s",
    "%1$s, %2$s, %3$s and %4$s" : "%1$s، %2$s، %3$s، ھەمدە %4$s",
    "%1$s, %2$s, %3$s, %4$s and %5$s" : "%1$s، %2$s، %3$s، %4$s ھەمدە %5$s",
    "Education bundle" : "مائارىپ باغچىسى",
    "Enterprise bundle" : "كارخانا توپلىمى",
    "Groupware bundle" : "گۇرۇپپا يۇمشاق دېتاللىرى",
    "Hub bundle" : "Hub توپلام",
    ...
    "%sbit or higher PHP required." : "%s بىتتىن ياكى ئۇنىڭدىن يۇقىرى PHP تەلەپ قىلىنىدۇ.",
    ...
    "same time" : "ئوخشاش ۋاقىت",
    "_%nh_::_%nh_" : ["%nسائەت","%nسائەت"],
    "_%nm_::_%nm_" : ["%nمىنۇت","%nمىنۇت"],
    "%s ahead" : "%s ئالىدىدا",
    "%s behind" : "%s كەينىدە",
    ...
    "tomorrow" : "ئەتە",
    "yesterday" : "تۈنۈگۈن",
    "_in %n day_::_in %n days_" : ["%n كۈندە","%n كۈندە"],
    "_%n day ago_::_%n days ago_" : ["%n كۈن ئىلگىرى","%n كۈن ئىلگىرى"],
    "next month" : "كېلەر ئاي",
    "last month" : "ئالدىنقى ئاي",
    "_in %n month_::_in %n months_" : ["%n ئايدا","%n ئايدا"],
    "_%n month ago_::_%n months ago_" : ["%n ئاي ئىلگىرى","%n ئاي ئىلگىرى"],
    "next year" : "كېلەر يىلى",
    "last year" : "ئۆتكەن يىلى",
    "_in %n year_::_in %n years_" : ["%n يىلدا","%n يىلدا"],
    "_%n year ago_::_%n years ago_" : ["%n يىل ئىلگىرى","%n يىل ئىلگىرى"],
    ...
    "Templates" : "قېلىپلار",
    "Storage %s cannot be moved" : "بوشلۇق %s نى يۆتكىگىلى بولمايدۇ",
    "Moving a share (%s) into a shared folder is not allowed" : "ئورتاقلىشىشنى (%s) ئورتاقلىشىش قىسقۇچقا يۆتكەشكە يول قويۇلمايدۇ",
    "Moving a storage (%s) into a shared folder is not allowed" : "ساقلىغۇچنى (%s) ئورتاق قىسقۇچقا يۆتكەشكە يول قويۇلمايدۇ",
    "Moving a share (%s) into another share (%s) is not allowed" : "بىر پاينى (%s) باشقا بىر پايغا (%s) يۆتكەشكە يول قويۇلمايدۇ",
    "Moving a share (%s) into another storage (%s) is not allowed" : "بىر ئورتاقلىشىشنى (%s) باشقا ساقلىغۇچقا (%s) يۆتكەشكە يول قويۇلمايدۇ",
    "Moving a storage (%s) into a share (%s) is not allowed" : "ساقلاش بوشلۇقىنى (%s) ئورتاقلىشىش بوشلۇقىغا (%s) يۆتكەشكە يول قويۇلمايدۇ",
    "Moving a storage (%s) into another storage (%s) is not allowed" : "بىر ساقلىغۇچنى (%s) باشقا ساقلىغۇچقا (%s) يۆتكەشكە يول قويۇلمايدۇ",
    ...
    "Extract text from files like images or PDFs" : "PDF ياكى سۈرەتتەك ھۆججەتلەردىن تېكىستنى چىقار",
    "Input files" : "كىرگۈزگۈچى ھۆججەتلەر",
    "The files to extract text from" : "تېكىست چىقىرۋالدىغان ھۆججەتلەر",
    "Output texts" : "نەتىنجە تېكىستلەر",
    "The texts that were extracted from the files" : "ھۆججەتلەردىن چىقىرۋېلىندىغان تېكىستلەر",
