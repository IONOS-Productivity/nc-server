OC.L10N.register(
    ...
    "%1$s should be true or false" : "%1$s powinno mieć wartość true lub false",
    "%1$s can only be set to %2$s through the API" : "%1$s może być ustawione na %2$s wyłącznie za pośrednictwem API",
