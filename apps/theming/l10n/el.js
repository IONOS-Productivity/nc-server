OC.L10N.register(
    ...
    "Invalid setting key" : "Μη έγκυρο κλειδί ρύθμισης",
    "Saved" : "Αποθηκεύτηκαν",
    "Invalid app given" : "Μη έγκυρη εφαρμογή",
    "Invalid type for setting \"defaultApp\" given" : "Μη έγκυρος τύπος για τη ρύθμιση \"defaultApp\"",
    ...
    "PHP Imagick module" : "Άρθρωμα PHP Imagick",
    ...
    "The PHP module \"imagick\" in this instance has no SVG support. For better compatibility it is recommended to install it." : "Το άρθρωμα PHP \"imagick\" σε αυτήν την περίπτωση δεν υποστηρίζει SVG. Για καλύτερη συμβατότητα, συνιστάται η εγκατάστασή του.",
    ...
    "Background and color" : "Παρασκήνιο και χρώμα",
    ...
    "Favicon" : "Favicon",
    "Logo" : "Λογότυπο",
    "Although you can select and customize your instance, users can change their background and colors. If you want to enforce your customization, you can toggle this on." : "Παρόλο που μπορείτε να επιλέξετε και να προσαρμόσετε την εγκατάστασή σας, οι χρήστες μπορούν να αλλάξουν το φόντο και τα χρώματά τους. Εάν θέλετε να επιβάλετε την προσαρμογή σας, μπορείτε να το ενεργοποιήσετε.",
