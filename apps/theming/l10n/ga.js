OC.L10N.register(
    "theming",
    {
    "The given name is too long" : "Tá an t-ainm a thugtar rófhada",
    "The given web address is too long" : "Tá an seoladh gréasáin a thugtar rófhada",
    "The given web address is not a valid URL" : "Níl an seoladh gréasáin a thugtar mar URL bailí",
    "The given legal notice address is too long" : "Tá an seoladh fógra dlí a thugtar rófhada",
    "The given legal notice address is not a valid URL" : "Ní URL bailí an seoladh fógra dlíthiúil a tugadh",
    "The given privacy policy address is too long" : "Tá an seoladh polasaí príobháideachta a thugtar ró-fhada",
    ...
    "Invalid type for setting \"defaultApp\" given" : "Cineál neamhbhailí don socrú \"defaultApp\" tugtha",
    ...
    "You are already using a custom theme. Theming app settings might be overwritten by that." : "Tá téama saincheaptha in úsáid agat cheana féin. Seans go mbeidh socruithe feidhmchláir téamaí forscríofa leis sin.",
    "Theming" : "Téamaí",
    "Appearance and accessibility" : "Cuma agus inrochtaineacht",
    "PHP Imagick module" : "Modúl PHP Imagick",
    ...
    "The PHP module \"imagick\" in this instance has no SVG support. For better compatibility it is recommended to install it." : "Níl aon tacaíocht SVG ag an modúl PHP \"imagick\" sa chás seo. Le haghaidh comhoiriúnacht níos fearr moltar é a shuiteáil.",
    "Dark theme with high contrast mode" : "Téama dorcha le modh ardchodarsnachta",
    "Enable dark high contrast mode" : "Cumasaigh mód dorcha ardchodarsnachta",
    "Similar to the high contrast mode, but with dark colours." : "Cosúil leis an modh ardchodarsnachta, ach le dathanna dorcha.",
    "Dark theme" : "Téama dorcha",
    "Enable dark theme" : "Cumasaigh téama dorcha",
    "A dark theme to ease your eyes by reducing the overall luminosity and brightness." : "Téama dorcha chun do shúile a mhaolú tríd an luminosity agus gile iomlán a laghdú.",
    "System default theme" : "Téama réamhshocraithe an chórais",
    "Enable the system default" : "Cumasaigh réamhshocrú an chórais",
    "Using the default system appearance." : "Ag baint úsáide as cuma an chórais réamhshocraithe.",
    "Dyslexia font" : "cló disléicse",
    "Enable dyslexia font" : "Cumasaigh cló disléicse",
    "OpenDyslexic is a free typeface/font designed to mitigate some of the common reading errors caused by dyslexia." : "Is cló saor in aisce OpenDyslexic é a cruthaíodh chun cuid de na botúin léitheoireachta coitianta a chóireáil a bhaineann le disléicse.",
    "High contrast mode" : "Modh ardchodarsnachta",
    "Enable high contrast mode" : "Cumasaigh modh ardchodarsnachta",
    "A high contrast mode to ease your navigation. Visual quality will be reduced but clarity will be increased." : "Modh ardchodarsnachta chun do sheoltóireacht a shaoradh. Beidh caighdeán radharcach laghdaithe ach ardófar an soiléireacht.",
    "Light theme" : "Téama éadrom",
    "Enable the default light theme" : "Cumasaigh an téama réamhshocraithe solais",
    "The default light appearance." : "An chuma éadrom réamhshocraithe.",
    ...
    "Legal notice link" : "Nasc fógra dlíthiúil",
    "Privacy policy link" : "Nasc polasaí príobháideachta",
    "Header logo" : "Lógó ceanntásca",
    "Upload new header logo" : "Íoslódáil an ceanntásc lógó nua",
    "Favicon" : "Favicon",
    "Upload new favicon" : "Íosluchtaigh favicon nua",
    ...
    "The background can be set to an image from the default set, a custom uploaded image, or a plain color." : "Is féidir an cúlra a shocrú d'íomhá ón tacar réamhshocraithe, íomhá saincheaptha uaslódáilte, nó dath simplí.",
    ...
    "Global default app" : "Aip réamhshocraithe domhanda",
