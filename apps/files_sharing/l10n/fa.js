OC.L10N.register(
    ...
    "Files have been <strong>uploaded</strong> to a folder shared by mail or by public link" : "فایل‌ها در پوشه‌ای که از طریق ایمیل یا لینک عمومی به اشتراک گذاشته شده است، آپلود شده‌اند.",
    ...
    "Custom share link tokens have been disabled by the administrator" : "توکن‌های لینک اشتراک‌گذاری سفارشی توسط مدیر غیرفعال شده‌اند",
    "Tokens must contain at least 1 character and may only contain letters, numbers, or a hyphen" : "توکن‌ها باید حداقل شامل ۱ کاراکتر باشند و فقط می‌توانند شامل حروف، اعداد یا خط تیره باشند.",
    ...
    "You are not allowed to send mail notifications" : "شما مجاز به ارسال اعلان‌های ایمیلی نیستید",
    ...
    "Remember to upload the files to %s" : "فراموش نکنید که فایل‌ها را در %s آپلود کنید",
    "We would like to kindly remind you that you have not yet uploaded any files to the shared folder." : "لطفاً به شما یادآوری می‌کنیم که هنوز هیچ فایلی را در پوشه اشتراکی آپلود نکرده‌اید.",
    "Open \"%s\"" : "باز کردن \"%s\"",
    "This application enables people to share files within Nextcloud. If enabled, the admin can choose which groups can share files. The applicable people can then share files and folders with other accounts and groups within Nextcloud. In addition, if the admin enables the share link feature, an external link can be used to share files with other people outside of Nextcloud. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the Nextcloud Documentation." : "این برنامه به افراد امکان می‌دهد تا فایل‌ها را در Nextcloud به اشتراک بگذارند. در صورت فعال بودن، مدیر می‌تواند انتخاب کند که کدام گروه‌ها می‌توانند فایل‌ها را به اشتراک بگذارند. سپس افراد مربوطه می‌توانند فایل‌ها و پوشه‌ها را با سایر حساب‌ها و گروه‌های درون Nextcloud به اشتراک بگذارند. علاوه بر این، اگر مدیر ویژگی لینک اشتراک‌گذاری را فعال کند، می‌توان از یک لینک خارجی برای اشتراک‌گذاری فایل‌ها با سایر افراد خارج از Nextcloud استفاده کرد. مدیران همچنین می‌توانند رمزهای عبور، تاریخ انقضا را اعمال کنند و اشتراک‌گذاری سرور به سرور را از طریق لینک‌های اشتراک‌گذاری و همچنین اشتراک‌گذاری از دستگاه‌های تلفن همراه فعال کنند. خاموش کردن این ویژگی، فایل‌ها و پوشه‌های اشتراک‌گذاری شده را روی سرور برای همه گیرندگان اشتراک‌گذاری و همچنین روی کلاینت‌های همگام‌سازی و برنامه‌های تلفن همراه حذف می‌کند. اطلاعات بیشتر در مستندات Nextcloud موجود است.",
    "Filter accounts" : "پالایش حساب‌ها",
    "you" : "شما",
    "The request will expire on {date} at midnight and will be password protected." : "این درخواست در {date}، نیمه شب، منقضی می‌شود و با رمز عبور محافظت خواهد شد.",
    ...
    "Open Sharing Details" : "جزئیات اشتراک‌گذاری را باز کنید",
    ...
    "Name, email, or Federated Cloud ID …" : "نام یا ایمیل یا شناسه‌ی فدرال ابری",
    ...
    "Upload files to {foldername}." : "فایل‌ها را در {foldername} آپلود کنید.",
    "By uploading files, you agree to the terms of service." : "با آپلود کردن، شما با شرایط خدمات موافقت می‌کنید.",
    "Successfully uploaded files" : "فایل‌ها با موفقیت آپلود شدند",
    ...
    "Share files within your organization. Recipients who can already view the file can also use this link for easy access." : "فایل‌ها را در سازمان خود به اشتراک بگذارید. گیرندگانی که از قبل می‌توانند فایل را مشاهده کنند، می‌توانند از این لینک نیز برای دسترسی آسان استفاده کنند.",
    "Share files with others outside your organization via public links and email addresses. You can also share to {productName} accounts on other instances using their federated cloud ID." : "فایل‌ها را از طریق لینک‌های عمومی و آدرس‌های ایمیل با دیگران در خارج از سازمان خود به اشتراک بگذارید. همچنین می‌توانید با استفاده از شناسه ابری فدرال آنها، فایل‌ها را با حساب‌های {productName} در موارد دیگر به اشتراک بگذارید.",
    "Shares from apps or other sources which are not included in internal or external shares." : "اشتراک‌گذاری‌ها از برنامه‌ها یا منابع دیگر که در اشتراک‌گذاری‌های داخلی یا خارجی لحاظ نشده‌اند.",
    "Type names, teams, federated cloud IDs" : "نام‌ها، تیم‌ها، شناسه‌های ابری فدرال را تایپ کنید",
    "Type names or teams" : "نام یا تیم‌ها را تایپ کنید",
    ...
    "Files and folders you shared or have been shared with you will show up here" : "فایل‌ها و پوشه‌هایی که به اشتراک گذاشته‌اید یا با شما به اشتراک گذاشته شده‌اند، در اینجا نمایش داده می‌شوند.",
    ...
    "Files and folders you shared will show up here" : "فایل‌ها و پوشه‌هایی که به اشتراک گذاشته‌اید در اینجا نمایش داده می‌شوند",
    "Shared by link" : "اشتراک گذاشته شده از طریق لینک",
    "List of files that are shared by link." : "فهرست فایل‌هایی که از طریق لینک به اشتراک گذاشته می‌شوند.",
    ...
    "List of shares you left." : "لیست اشتراک‌هایی که باقی گذاشته‌اید.",
    "No deleted shares" : "اشتراک گذاری های حذف نشده",
    "Shares you have left will show up here" : "اشتراک‌گذاری‌هایی که انجام داده‌اید اینجا نمایش داده می‌شوند",
    "Pending shares" : "اشتراک در حال انتظار ",
    "List of unapproved shares." : "فهرست اشتراک‌های تایید نشده",
    "No pending shares" : "بدون اشتراک در حال انتظار",
    "Shares you have received but not approved will show up here" : "اشتراک‌هایی که دریافت کرده‌اید اما تأیید نشده‌اند، در اینجا نمایش داده می‌شوند.",
    "Error deleting the share: {errorMessage}" : "خطا در حذف اشتراک‌گذاری: {errorMessage}",
    "Error deleting the share" : "خطا در حذف اشتراک‌گذاری",
    "Error updating the share: {errorMessage}" : "خطا در به‌روزرسانی اشتراک‌گذاری: {errorMessage}",
    "Error updating the share" : "خطایی در به روزرسانی اشتراک",
    "File \"{path}\" has been unshared" : "فایل \"{path}\" از حالت اشتراک‌گذاری خارج شد.",
    "Folder \"{path}\" has been unshared" : "پوشه \"{path}\" از حالت اشتراک‌گذاری خارج شده است.",
    "Could not update share" : "نتوانستم اشتراک‌گذاری را به‌روزرسانی کنم",
    "Share saved" : "اشتراک‌گذاری ذخیره شد",
    "Share expiry date saved" : "تاریخ انقضای اشتراک‌گذاری ذخیره شد",
    "Share hide-download state saved" : "اشتراک‌گذاری مخفی کردن-دانلود وضعیت ذخیره شد",
    "Share label saved" : "برچسب اشتراک‌گذاری ذخیره شد",
    "Share note for recipient saved" : "اشتراک‌گذاری یادداشت برای کانتینر ذخیره‌شده",
    "Share password saved" : "اشتراک‌گذاری گذرواژه ذخیره شده",
    "Share permissions saved" : "مجوزهای اشتراک‌گذاری ذخیره شد",
    ...
    "Upload files to {folder}" : "فایل‌ها را در {folder} آپلود کنید",
    "Please confirm your name to upload files to {folder}" : "لطفا نام خود را برای آپلود فایل‌ها در {folder} تأیید کنید",
    ...
    "Only works for people with access to this folder" : "فقط برای افرادی که به این پوشه دسترسی دارند کار می‌کند",
    "Only works for people with access to this file" : "فقط برای افرادی که به این فایل دسترسی دارند کار می‌کند",
    "Copy public link of \"{title}\" to clipboard" : "پیوند عمومی \"{title}\" را در کلیپ‌بورد کپی کنید",
    "Name or email …" : "نام یا ایمیل",
    "Name, email, or Federated Cloud ID …" : "نام یا ایمیل یا شناسه‌ی فدرال ابری",
    "Searching …" : "جستجوکردن …",
    "Search globally" : "در سطح جهان جستجو کنید",
    "Submit name" : "ارسال نام",
    "To upload files, you need to provide your name first." : "برای آپلود فایل‌ها، ابتدا باید نام خود را وارد کنید.",
    "Name" : "نام",
    "Enter your name" : "اسمت را وارد کن",
    "Share with {userName}" : "اشتراک‌گذاری با {userName}",
    "Use this method to share files with individuals or teams within your organization. If the recipient already has access to the share but cannot locate it, you can send them the internal share link for easy access." : "از این روش برای اشتراک‌گذاری فایل‌ها با افراد یا تیم‌های درون سازمان خود استفاده کنید. اگر گیرنده از قبل به فایل اشتراکی دسترسی دارد اما نمی‌تواند آن را پیدا کند، می‌توانید لینک اشتراک‌گذاری داخلی را برای دسترسی آسان برای او ارسال کنید.",
    "Use this method to share files with individuals or organizations outside your organization. Files and folders can be shared via public share links and email addresses. You can also share to other Nextcloud accounts hosted on different instances using their federated cloud ID." : "از این روش برای اشتراک‌گذاری فایل‌ها با افراد یا سازمان‌های خارج از سازمان خود استفاده کنید. فایل‌ها و پوشه‌ها را می‌توان از طریق لینک‌های اشتراک‌گذاری عمومی و آدرس‌های ایمیل به اشتراک گذاشت. همچنین می‌توانید با سایر حساب‌های Nextcloud که در نمونه‌های مختلف با استفاده از شناسه ابری فدرال آنها میزبانی می‌شوند، به اشتراک بگذارید.",
    "Shares that are not part of the internal or external shares. This can be shares from apps or other sources." : "اشتراک‌گذاری‌هایی که بخشی از اشتراک‌گذاری‌های داخلی یا خارجی نیستند. این موارد می‌توانند از برنامه‌ها یا منابع دیگر به اشتراک گذاشته شوند.",
    "Share with accounts, teams, federated cloud id" : "اشتراک‌گذاری با حساب‌ها، تیم‌ها، شناسه ابری فدرال",
    "Share with accounts and teams" : "اشتراک‌گذاری با حساب‌ها و تیم‌ها",
    "Federated cloud ID" : "شناسه‌ ی فدرال ابری",
    "Email, federated cloud id" : "ایمیل یا شناسه ی فدارل ابری",
    "Show sharing options" : "نمایش گزینه‌های اشتراک‌گذاری",
