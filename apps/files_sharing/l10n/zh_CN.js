OC.L10N.register(
    ...
    "{actor} shared as public link" : "{actor} 作为公开链接共享",
    "{actor} removed public link" : "{actor} 已移除公开链接",
    "Public link of {actor} expired" : "{actor} 的公开链接已过期",
    "You shared {file} as public link" : "您将 {file} 作为公开链接共享",
    ...
    "A file or folder shared by mail or by public link was <strong>downloaded</strong>" : "<strong>已下载</strong>通过邮件或公开链接共享的文件或文件夹",
    ...
    "You do not have enough permissions to share this file." : "您没有足够的权限共享此文件。",
    "People" : "用户",
