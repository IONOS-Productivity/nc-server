OC.L10N.register(
    ...
    "{actor} shared as public link" : "Kasutaja „{actor}“ jagas avaliku lingina",
    "{actor} removed public link" : "Kasutaja „{actor}“ eemaldas avaliku lingi",
    "Public link of {actor} expired" : "Kasutaja „{actor}“ avalik link aegus",
    "You shared {file} as public link" : "Sa jagasid „{file}“ faili avaliku lingina",
    "You removed public link for {file}" : "Sa eemaldasid „{file}“ faili avaliku lingi",
    "Public link expired for {file}" : "„{file}“ faili avalik link aegus",
    "{actor} shared {file} as public link" : "{actor} jagas „{file}“ faili avaliku lingina",
    "{actor} removed public link for {file}" : "{actor} eemaldas „{file}“ faili avaliku lingi",
    "Public link of {actor} for {file} expired" : "Kasutaja „{actor}“ „{file}“ faili avalik link aegus",
    ...
    "{user} accepted the remote share of {file}" : "{user} aksepteeris „{file}“ faili kaugjagamise",
    "{user} declined the remote share of {file}" : "{user} keeldus „{file}“ faili kaugjagamisest",
    "{user} unshared {file} from you" : "{user} lõpetas sinuga „{file}“ faili jagamise",
