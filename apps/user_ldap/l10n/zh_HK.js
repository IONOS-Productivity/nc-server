OC.L10N.register(
    ...
    "The filter specifies which LDAP groups shall have access to the {instanceName} instance." : "過濾器指定哪些 LDAP 群組將有權存取 {instanceName}。",
    ...
    "Allows login against the LDAP/AD username, which is either 'uid' or 'sAMAccountName' and will be detected." : "允許使用 LDAP/AD 用戶名登入，該用戶名可以是「uid」或「sAMAccountName」，會自動檢測到。",
    ...
    "Port" : "連接埠",
    "Detect Port" : "偵測連接埠",
    "The DN of the client user with which the bind shall be done. For anonymous access, leave DN and Password empty." : "客戶端用戶的DN與特定字詞的連結需要完善。若需匿名存取，請將識別碼與密碼欄位留空。",
    "User DN" : "用戶 DN",
