OC.L10N.register(
    ...
    "Groups meeting these criteria are available in {instanceName}:" : "Группы, отвечающие этим критериям доступны в {instanceName}:",
    ...
    "The filter specifies which LDAP groups shall have access to the {instanceName} instance." : "Этот фильтр определяет какие LDAP группы должны иметь доступ к экземпляру {instanceName}.",
    "LDAP Filter:" : "Фильтр LDAP:",
    "Verify settings and count the groups" : "Проверить настройки и пересчитать группы",
    "User not found. Please check your login attributes and username. Effective filter (to copy-and-paste for command-line validation): {filter}" : "Пользователь не найден. Проверьте данные для входа и имя пользователя. Действующий фильтр (для копирования и вставки при проверке в командой строке): {filter}",
    "User found and settings verified." : "Пользователь найден и настройки проверены.",
    "Consider narrowing your search, as it encompassed many users, only the first one of whom will be able to log in." : "Подумайте о сужении поиска, поскольку он охватывает многих пользователей, но только первый из которых сможет войти в систему.",
    "An unspecified error occurred. Please check log and settings." : "Произошла неуказанная ошибка.  Проверьте настройки и журнал.",
    "The search filter is invalid, probably due to syntax issues like uneven number of opened and closed brackets. Please revise." : "Некорректный фильтр поиска, возможно из-за синтаксических проблем, таких как несоответствие открывающих и закрывающих скобок. Пожалуйста проверьте.",
    ...
    "Test Login name" : "Проверить логин",
    ...
    "The filter specifies which LDAP users shall have access to the {instanceName} instance." : "Этот фильтр указывает, какие пользователи LDAP должны иметь доступ к экземпляру {instanceName}.",
    "Verify settings and count users" : "Проверить настройки и пересчитать пользователей",
    "User count: {usersCount}" : "Число пользователей: {usersCount}",
    ...
    "Expert" : "Эксперт",
    "The PHP LDAP module is not installed, the backend will not work. Please ask your system administrator to install it." : "Модуль LDAP для PHP не установлен, бэкенд не будет работать. Пожалуйста, попросите вашего системного администратора его установить. ",
    "Select LDAP Config" : "Выбрать конфигурацию LDAP",
    "Create New Config" : "Создать новую конфигурацию",
