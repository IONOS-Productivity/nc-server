OC.L10N.register(
    ...
    "Allows login against the LDAP/AD username, which is either 'uid' or 'sAMAccountName' and will be detected." : "Permite acceder co nome de usuario LDAP/AD, que pode ser 'uid' ou 'sAMAccountName' e que vai ser detectado.",
    ...
    "The DN of the client user with which the bind shall be done. For anonymous access, leave DN and Password empty." : "O DN do cliente do usuario co que realizará o vínculo, Para o acceso anónimo deixe o DN e o contrasinal baleiros.",
