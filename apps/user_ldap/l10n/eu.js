OC.L10N.register(
    ...
    "UUID Attribute for Users" : "UUID atributua erabiltzaileentzat",
    "UUID Attribute for Groups" : "UUID atributua taldeentzat",
    "Groups meeting these criteria are available in {instanceName}:" : "Irizpide hauek betetzen dituzten taldeak {instanceName}-n daude eskuragarri:",
    ...
    "A connection error to LDAP/AD occurred. Please check host, port and credentials." : "LDAP/AD konexio errore bat gertatu da, mesedez egiaztatu ostalaria, ataka eta kredentzialak.",
    "The \"%uid\" placeholder is missing. It will be replaced with the login name when querying LDAP/AD." : "\"%u id\" leku-marka falta da. LDAP/AD kontsultatzerakoan saioa hasteko izenarekin ordezkatuko da.",
    "When logging in, {instanceName} will find the user based on the following attributes:" : "Saioa hastean, {instanceName}-k honako atributu hauetan oinarrituta aurkituko du erabiltzailea:",
    "Allows login against the LDAP/AD username, which is either 'uid' or 'sAMAccountName' and will be detected." : "aukera ematen du erabiltzaile-izenarekin LDAP/ADn saioa hasteko , hau da, 'uid' edo 'sAMAccountName' detektatu egingo da.",
    "LDAP/AD Username:" : "LDAP/AD erabiltzaile-izena:",
    "Allows login against an email attribute. 'mail' and 'mailPrimaryAddress' allowed." : "Aukera ematen du saioa hasteko posta elektronikoko atributu baten bidez . 'mail' eta 'mailPrimaryAddress' onartzen dira.",
