OC.L10N.register(
    ...
    "Groups meeting these criteria are available in {instanceName}:" : "{instanceName} içinde bu ölçüte uygun gruplar var:",
    ...
    "The filter specifies which LDAP groups shall have access to the {instanceName} instance." : "Süzgeçte {instanceName} kopyasına erişebilecek LDAP grupları belirtilir.",
    ...
    "No object found in the given Base DN. Please revise." : "Belirtilen Base DN içerisinde herhangi bir nesne bulunamadı. Lütfen gözden geçirin.",
    "More than 1,000 directory entries available." : "Kullanılabilecek dizin sayısı 1000 üzerinde.",
    "_{ldapTestBase} entry available within the provided Base DN_::_{ldapTestBase} entries available within the provided Base DN_" : ["Belirtilen Base DN üzerinde {ldapTestBase} kayıt var","Belirtilen Base DN üzerinde {ldapTestBase} kayıt var"],
    ...
    "The DN of the client user with which the bind shall be done. For anonymous access, leave DN and Password empty." : "Yapılacak bağlama için istemci kullanıcısının DN değeri. Anonim erişim için DN ve Parolayı boş bırakın.",
    ...
    "The filter specifies which LDAP users shall have access to the {instanceName} instance." : "Süzgeç, {instanceName} kopyasına erişmesi gereken LDAP kullanıcılarını belirtir.",
    "Verify settings and count users" : "Ayarları doğrula ve kullanıcıları say",
    "User count: {usersCount}" : "Kullanıcı sayısı: {usersCount}",
    ...
    "Advanced" : "Gelişmiş",
    "Expert" : "Uzman",
    "The PHP LDAP module is not installed, the backend will not work. Please ask your system administrator to install it." : "PHP LDAP modülü kurulmamış, arka yüz çalışmayacak. Lütfen kurması için BT yöneticiniz ile görüşün.",
    "Select LDAP Config" : "LDAP yapılandırmasını seçin",
    "Create New Config" : "Yeni yapılandırma oluştur",
    "Create configuration" : "Yapılandırma ekle",
