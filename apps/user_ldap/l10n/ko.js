OC.L10N.register(
    ...
    "User not found. Please check your login attributes and username. Effective filter (to copy-and-paste for command-line validation): <br/>" : "사용자를 찾을 수 없습니다. 로그인 속성과 사용자 이름을 확인하십시오. 사용한 필터(명령행에서 검증하려면 복사 및 붙여넣기):",
    ...
    "_%n user found_::_%n users found_" : ["%n명의 사용자 찾음"],
    ...
    "When switched on, users imported from LDAP which are then missing will be disabled" : "이 옵션을 켜면 LDAP에서 불러온 사용자 중 유실된 계정이 비활성화될 것입니다",
    "Disable users missing from LDAP" : "LDAP에서 유실된 사용자 비활성화",
    ...
    "$home in an external storage configuration will be replaced with the value of the specified attribute" : "외부 저장소 설정에서 $home이 지정된 속성의 값으로 대체됩니다",
    "User Profile Attributes" : "사용자 프로필 속성",
    "Phone Field" : "전화번호 필드",
    "User profile Phone will be set from the specified attribute" : "사용자 프로필의 전화번호가 지정된 속성으로 설정됩니다",
    "Website Field" : "웹사이트 필드",
    "User profile Website will be set from the specified attribute" : "사용자 프로필의 웹사이트가 지정된 속성으로 설정됩니다",
    "Address Field" : "주소 필드",
    "User profile Address will be set from the specified attribute" : "사용자 프로필의 주소가 지정된 속성으로 설정됩니다",
    "Twitter Field" : "Twitter 필드",
    "User profile Twitter will be set from the specified attribute" : "사용자 프로필의 Twitter가 지정된 속성으로 설정됩니다",
    "Fediverse Field" : "Fediverse 필드",
    "User profile Fediverse will be set from the specified attribute" : "사용자 프로필의 Fediverse가 지정된 속성으로 설정됩니다",
    "Organisation Field" : "조직 필드",
    "User profile Organisation will be set from the specified attribute" : "사용자 프로필의 조직 필드가 지정된 속성으로 설정됩니다",
    "Role Field" : "직책 필드",
    "User profile Role will be set from the specified attribute" : "사용자 프로필의 직책이 지정된 속성으로 설정됩니다",
    "Headline Field" : "표제 필드",
    "User profile Headline will be set from the specified attribute" : "사용자 프로필의 표제가 지정된 속성으로 설정됩니다",
    "Biography Field" : "소개문구 필드",
    "User profile Biography will be set from the specified attribute" : "사용자 프로필의 소개문구가 지정된 속성으로 설정됩니다",
    "User profile Date of birth will be set from the specified attribute" : "사용자 프로필 생년월일은 지정된 속성에서 설정됩니다.",
