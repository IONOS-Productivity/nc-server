OC.L10N.register(
    ...
    "User Profile Attributes" : "Användarprofilattribut",
    "Phone Field" : "Telefon",
    "User profile Phone will be set from the specified attribute" : "Telefon i användarprofilen kommer att ställas in från det angivna attributet",
    "Website Field" : "Webbplats",
    "User profile Website will be set from the specified attribute" : "Webbplats i användarprofilen kommer att ställas in från det angivna attributet",
    "Address Field" : "Adress",
    "User profile Address will be set from the specified attribute" : "Adress i användarprofilen kommer att ställas in från det angivna attributet",
    "Twitter Field" : "Twitter",
    "User profile Twitter will be set from the specified attribute" : "Twitter i användarprofilen kommer att ställas in från det angivna attributet",
    "Fediverse Field" : "Fediverse",
    "User profile Fediverse will be set from the specified attribute" : "Fediverse i användarprofilen kommer att ställas in från det angivna attributet",
    "Organisation Field" : "Organisation",
    "User profile Organisation will be set from the specified attribute" : "Organisation i användarprofilen kommer att ställas in från det angivna attributet",
    "Role Field" : "Roll",
    "User profile Role will be set from the specified attribute" : "Roll i användarprofilen kommer att ställas in från det angivna attributet",
    "Headline Field" : "Rubrik",
    ...
    "Groups meeting these criteria are available in {instanceName}:" : "Grupper som uppfyller dessa kriterier finns i {instanceName}:",
    ...
    "The filter specifies which LDAP groups shall have access to the {instanceName} instance." : "Filtret specificerar vilka LDAP-grupper som ska ha åtkomst till {instanceName} instans",
    "LDAP Filter:" : "LDAP Filter:",
    "Verify settings and count the groups" : "Verifiera inställningar och räkna grupperna",
    "User not found. Please check your login attributes and username. Effective filter (to copy-and-paste for command-line validation): {filter}" : "Användaren hittades inte. Vänligen kontrollera dina inloggningsattribut och användarnamn. Effektivt filter (för att kopiera och klistra in för kommandoradsvalidering): {filter}",
    "User found and settings verified." : "Användare hittad och inställnings bekräftade.",
    "Consider narrowing your search, as it encompassed many users, only the first one of whom will be able to log in." : "Överväg att specificera din sökning eftersom den resulterade i många användare och bara den första kommer att kunna logga in.",
    "An unspecified error occurred. Please check log and settings." : "Ett ospecificerat fel inträffade. Vänligen kontrollera loggen och inställningarna.",
    "The search filter is invalid, probably due to syntax issues like uneven number of opened and closed brackets. Please revise." : "Sökfiltret är ogiltigt, troligen på grund av syntaxproblem som ojämnt antal öppna och slutna klamrar. Vänligen granska.",
    "A connection error to LDAP/AD occurred. Please check host, port and credentials." : "Ett anslutningsfel till LDAP/AD uppstod. Kontrollera server, port och inloggningsuppgifter.",
    "The \"%uid\" placeholder is missing. It will be replaced with the login name when querying LDAP/AD." : "\"%uid\"-platshållaren saknas. Den kommer att ersättas med inloggningsnamn när LDAP/AD efterfrågas.",
    "When logging in, {instanceName} will find the user based on the following attributes:" : "Vid inloggning, {instanceName} kan hitta användaren baserat på följande attribut:",
    ...
    "Attempts to receive a DN for the given login name and the current login filter" : "Försöker att få ett DN för det angivna inloggningsnamnet och det aktuella inloggningsfiltret",
    ...
    "Copy configuration" : "Kopiera konfiguration",
    ...
    "The DN of the client user with which the bind shall be done. For anonymous access, leave DN and Password empty." : "Klientanvändarens namn (DN) som bindningen ska göras med. För anonym åtkomst, lämna DN och lösenord tomma.",
    "User DN" : "Användar-DN",
    ...
    "The filter specifies which LDAP users shall have access to the {instanceName} instance." : "Filtret specificerar vilka LDAP-användare som skall ha åtkomst till {instanceName} instans",
    "Verify settings and count users" : "Verifiera inställningar och räkna användare",
    "User count: {usersCount}" : "Antal användare: {usersCount}",
    ...
    "Advanced" : "Avancerad",
    "Expert" : "Expert",
    "The PHP LDAP module is not installed, the backend will not work. Please ask your system administrator to install it." : "PHP LDAP-modul är inte installerad. Be din systemadministratör att installera den.",
    "Select LDAP Config" : "Välj LDAP-konfiguration",
    "Create New Config" : "Skapa ny konfiguration",
    "Create configuration" : "Skapa konfiguration",
