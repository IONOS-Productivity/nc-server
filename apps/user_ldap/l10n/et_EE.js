OC.L10N.register(
    ...
    "Please check the credentials, they seem to be wrong." : "Palun kontrolli kasutajaandmeid, need näivad olevat valed.",
    "Please specify the port, it could not be auto-detected." : "Palun valige port, seda pole võimalik automaatselt tuvastada",
    "Base DN could not be auto-detected, please revise credentials, host and port." : "BaasDN-i ei saa automaatselt tuvastada, palun vaata üle kasutajaandned, server ja port.",
