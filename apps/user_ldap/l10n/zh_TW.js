OC.L10N.register(
    ...
    "Port" : "連接埠",
    "Detect Port" : "偵測連接埠",
    "The DN of the client user with which the bind shall be done. For anonymous access, leave DN and Password empty." : "將用於執行綁定操作的客戶端使用者 DN。若需匿名存取，請將識別碼與密碼欄位留空。",
    "User DN" : "使用者 DN",
