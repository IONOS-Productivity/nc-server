OC.L10N.register(
    ...
    "{displayName} (restricted)" : "{displayName} (restrito)",
    ...
    "Create new tag" : "Criar etiqueta nova",
    ...
    "Tags you have created will show up here." : "As etiquetas que você criou aparecerão aqui.",
