OC.L10N.register(
    ...
    "Storage with ID \"%d\" is not editable by non-admins" : "\"%d\" kimlikli depolama yönetici olmayanlar tarafından düzenlenebilir değil",
    ...
    "Login and password" : "Kullanıcı adı ve parola",
    "Log-in credentials, save in session" : "Oturum kimlik doğrulama bilgileri, oturuma kaydet",
    "Global credentials, manually entered" : "Genel kimlik doğrulama bilgileri, el ile yazılmış",
    "Manually entered, store in database" : "El ile yazıldı, veri tabanında sakla",
    ...
    "Incomplete configuration" : "Yapılandırma tamamlanmamış",
    ...
    "\"%1$s\" is not installed. Mounting of %2$s is not possible. Please ask your system administrator to install it." : "\"%1$s\" kurulmamış. %2$s\" bağlanamaz. Lütfen kurulum için BT yöneticiniz ile görüşün.",
    "Checking storage …" : "Depolama alanı denetleniyor…",
    "Type to select account or group." : "Hesap ya da grup seçmek için yazın.  ",
    "(Group)" : "(Grup)",
