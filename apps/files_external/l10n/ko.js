OC.L10N.register(
    ...
    "Storage with ID \"%d\" is not editable by non-admins" : "저장소 ID \"%d\"을(를) 비관리자가 편집할 수 없음",
    "Access key" : "접근 키",
    "Secret key" : "비밀 키",
    "Builtin" : "내장",
    "None" : "없음",
    ...
    "Login and password" : "로그인 및 암호",
    "Log-in credentials, save in session" : "로그인 인증 정보, 세션에 저장됨",
    "Global credentials, manually entered" : "전역 자격 증명, 수동으로 입력됨",
    "Manually entered, store in database" : "수동으로 입력됨, 데이터베이스에 저장",
    ...
    "External storage enables you to mount external storage services and devices as secondary Nextcloud storage devices. You may also allow people to mount their own external storage services." : "외부 저장소를 사용하여 외부 저장소 서비스나 장치를 Nextcloud 이차 저장 장치로 마운트할 수 있습니다. 사용자가 개별 외부 저장소 서비스를 마운트할 수 있도록 허용할 수도 있습니다.",
    "Configuration" : "설정",
