OC.L10N.register(
    ...
    "System address book disabled" : "Kerfisnafnaskrá er óvirk",
    "The system contacts address book has been automatically disabled during upgrade. This means that the address book will no longer be available to users in the contacts app or other clients. The system contacts address book was disabled because the amount of contacts in the address book exceeded the maximum recommended number of contacts. This limit is set to prevent performance issues. You can re-enable the system address book with the following command {command}" : "Kerfisnafnaskráin hefur verið gerð óvirk sjálfvirkt við uppfærslu. Þetta þýðir að nafnaskráin verður ekki lengur aðgengileg notendum í tengiliðaforritum eða öðrum biðlarahugbúnaði. Kerfisnafnaskráin var gerð óvirk vegna þess að hún inniheldur fleiri tengiliði en ráðlagðan hámarksfjölda tengiliða. Þú getur endurvirkjað kerfisnafnaskrána með eftirfarandi skipun {command}",
    ...
    "Welcome to Nextcloud Calendar!\n\nThis is a sample event - explore the flexibility of planning with Nextcloud Calendar by making any edits you want!\n\nWith Nextcloud Calendar, you can:\n- Create, edit, and manage events effortlessly.\n- Create multiple calendars and share them with teammates, friends, or family.\n- Check availability and display your busy times to others.\n- Seamlessly integrate with apps and devices via CalDAV.\n- Customize your experience: schedule recurring events, adjust notifications and other settings." : "Velkomin í Nextcloud-dagatalið!\n\nÞetta er sýnishorn af atburði - skoðaðu sveigjanleika í skipulagningu með Nextcloud-dagatalinu með því að gera þær breytingar sem þig lystir!\n\nMeð Nextcloud-dagatalinu geturðu:\n- Útbúið, breytt og sýslað með atburði á einfaldan máta.\n- Útbúið mörg dagatöl og deilt þeim með vinnufélögum, vinum og fjölskyldu.\n- Skoðað lausa tíma og sýnt öðrum hvenær þú sért upptekin/n.\n- Samþætt upplýsingar hnökralaust við forrit og tæki í gegnum CalDAV.\n- Sérsniðið vinnuferlin þín: áætlað endurtekna atburði, aðlagað tilkynningar og fleiri stillingar.",
    "Example event - open me!" : "Dæmi um atburð - opna mig!",
    "System Address Book" : "Kerfisnafnaskrá",
    "The system address book contains contact information for all users in your instance." : "Kerfisnafnaskráin inniheldur tengiliðaupplýsingar um alla notendur á netþjónstilvikinu þínu.",
    "Enable System Address Book" : "Virkja kerfisnafnaskrá",
    ...
    "DAV system address book size" : "Stærð DAV-kerfisnafnaskrár",
    "The system address book is disabled" : "Kerfisnafnaskráin er óvirk",
    "The system address book is enabled, but contains more than the configured limit of %d contacts" : "Kerfisnafnaskráin er virk, en hún inniheldur fleiri en uppsett takmörk við %d tengiliði",
    "The system address book is enabled and contains less than the configured limit of %d contacts" : "Kerfisnafnaskráin er virk og inniheldur færri en uppsett takmörk við %d tengiliði",
    ...
    "Contact reset successfully" : "Tókst að endurstilla tengilið",
    "Error while resetting contact" : "Villa við að endurstilla tengilið",
    "Contact imported successfully" : "Tókst að flytja inn tengilið",
    "Error while importing contact" : "Villa við að flytja inn tengilið",
    "Import contact" : "Flytja inn tengilið",
    "Reset to default" : "Endurstilla á sjálfgefið",
    "Import contacts" : "Flytja inn tengiliði",
    "Importing a new .vcf file will delete the existing default contact and replace it with the new one. Do you want to continue?" : "Innflutningur á nýrri .vcf-skrá mun eyða fyrirliggjandi sjálfgefnum tengilið og skipta honum út fyrir þann nýja. Viltu halda áfram?",
    "Failed to save example event creation setting" : "Mistókst að vista stillingu fyrir sýnisatburð",
    "Failed to upload the example event" : "Gat ekki sent inn sýnisatburð",
    "Custom example event was saved successfully" : "Tókst að vista sérsniðinn sýnisatburð",
    "Failed to delete the custom example event" : "Mistókst að eyða sérsniðinn sýnisatburð",
    "Custom example event was deleted successfully" : "Tókst að eyða sérsniðnum sýnisatburði",
