OC.L10N.register(
    ...
    "System address book disabled" : "系统通讯录已禁用",
    "The system contacts address book has been automatically disabled during upgrade. This means that the address book will no longer be available to users in the contacts app or other clients. The system contacts address book was disabled because the amount of contacts in the address book exceeded the maximum recommended number of contacts. This limit is set to prevent performance issues. You can re-enable the system address book with the following command {command}" : "系统联系人通讯录在升级期间已自动禁用。这意味着联系人应用或其他客户端中的用户将无法再使用通讯录。系统联系人通讯录已禁用，因为通讯录中的联系人数量超过了推荐的最大联系人数量。设置此限制是为了防止性能问题。您可以使用以下命令重新启用系统通讯录 {command}",
    "Accounts" : "账号",
    ...
    "DAV system address book size" : "DAV 系统通讯录大小",
    "The system address book is disabled" : "系统通讯录已禁用",
    "The system address book is enabled, but contains more than the configured limit of %d contacts" : "系统通讯录已启用，但包含的联系人超过了配置的 %d 个限制",
    "The system address book is enabled and contains less than the configured limit of %d contacts" : "系统通讯录已启用，且包含的联系人少于配置的 %d 个限制",
