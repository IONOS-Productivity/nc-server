OC.L10N.register(
    ...
    "The administration enabled server-side-encryption. Your files were encrypted using the password <strong>%s</strong>." : "Administracja włączyła szyfrowanie po stronie serwera. Twoje pliki zostały zaszyfrowane z użyciem hasła <strong>%s</strong>",
    "The administration enabled server-side-encryption. Your files were encrypted using the password \"%s\"." : "Administracja włączyła szyfrowanie po stronie serwera. Twoje pliki zostały zaszyfrowane z użyciem hasła \"%s\".",
    "Please login to the web interface, go to the \"Security\" section of your personal settings and update your encryption password by entering this password into the \"Old login password\" field and your current login password." : "Zaloguj się poprzez interfejs WEB, przejdź do zakładki \"ochrona\" w Twoich ustawieniach oraz zaktualizuj Twoje hasło szyfrowania wpisując je w pole \"stare hasło logowania\" i Twój aktualny login.",
    ...
    "The recovery key is an additional encryption key used to encrypt files. It is used to recover files from an account if the password is forgotten." : "Klucz odzyskiwania to dodatkowy klucz szyfrowania używany do szyfrowania plików. Służy do odzyskiwania plików z konta w przypadku zapomnienia hasła.",
