OC.L10N.register(
    ...
    "Invalid private key for encryption app. Please update your private key password in your personal settings to recover access to your encrypted files." : "מפתח פרטי שגוי ליישומון הצפנה. נא לעדכן את ססמת המפתח הפרטי בהגדרות האישיות שלך כדי לשחזר את הגישה לקבצים המוצפנים שלך.",
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "יישומון ההצפנה מופעל אך המפתחות שלך לא אותחלו. נא לצאת מהחשבון ולהיכנס שוב.",
    "Please enable server side encryption in the admin settings in order to use the encryption module." : "נא להפעיל הצפנה מצד השרת בהגדרות הניהול כדי להשתמש במודול ההצפנה.",
    "Encryption app is enabled and ready" : "יישומון ההצפנה מופעל ומוכן",
