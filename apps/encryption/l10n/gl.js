OC.L10N.register(
    ...
    "Invalid private key for encryption app. Please update your private key password in your personal settings to recover access to your encrypted files." : "A chave privada para a aplicación de cifraxe non é correcta. Actualice o contrasinal da súa chave privada nos seus axustes persoais para recuperar o acceso aos seus ficheiros cifrados.",
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "A aplicación de cifraxe está activada, mais non foron preparadas as chaves. Saia da sesión e volva acceder de novo",
    "Please enable server side encryption in the admin settings in order to use the encryption module." : "Active a cifraxe no lado do servidor nos axustes de administración para poder usar o módulo de cifraxe.",
    "Encryption app is enabled and ready" : " A aplicación de cifraxe está activada e preparada",
    "Bad Signature" : "Sinatura errónea",
    "Missing Signature" : "Non se atopa a sinatura",
    "one-time password for server-side-encryption" : "Contrasinal de só un uso para a cifraxe no lado do servidor",
    "Encryption password" : "Contrasinal de cifraxe",
    "The administration enabled server-side-encryption. Your files were encrypted using the password <strong>%s</strong>." : "A administración activou a cifraxe no lado do servidor. Os seus ficheiros foron cifrados co contrasinal <strong>%s</strong>.",
    "The administration enabled server-side-encryption. Your files were encrypted using the password \"%s\"." : "A administración activou a cifraxe no lado do servidor. Os seus ficheiros foron cifrados co contrasinal «%s».",
    "Please login to the web interface, go to the \"Security\" section of your personal settings and update your encryption password by entering this password into the \"Old login password\" field and your current login password." : "Acceda na interface web, vaia á sección «Seguranza» dos seus axustes persoais e actualice o seu contrasinal de cifraxe introducindo este contrasinal no campo «Contrasinal antigo de acceso» e o seu contrasinal de acceso actual.",
