OC.L10N.register(
    ...
    "One time login" : "Logowanie jednorazowe",
    "QR Code login" : "Logowanie kodem QR",
    ...
    "Settings presets" : "Ustawienia wstępne",
    ...
    "List of invalid files…" : "Lista nieprawidłowych plików…",
    ...
    "Nextcloud %d does not support your current version, so be sure to update the database before updating your Nextcloud Server." : "Nextcloud %d nie obsługuje bieżącej wersji, dlatego przed aktualizacją serwera Nextcloud należy zaktualizować bazę danych.",
    "Oracle version \"%1$s\" detected. Oracle >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Wykryto wersję Oracle \"%1$s\". Dla najlepszej wydajności, stabilności i funkcjonalności z tą wersją Nextcloud zalecana jest Oracle ≥ %2$s i ≤ %3$s.",
    ...
    "Second factor configuration" : "Konfiguracja drugiego czynnika",
    "This instance has no second factor provider available." : "Ta instancja nie ma dostępnego dostawcy drugiego czynnika.",
    "Second factor providers are available but two-factor authentication is not enforced." : "Dostawcy drugiego czynnika są dostępni, ale uwierzytelnianie dwuskładnikowe nie jest wymuszane.",
    "Second factor providers are available and enforced: %s." : "Dostawcy drugiego czynnika są dostępni i wymuszani: %s.",
    ...
    "Exclude some groups" : "Wyklucz niektóre grupy",
    "Allow some groups" : "Zezwól niektórym grupom",
    ...
    "Enforce expiration date for link or mail shares" : "Wymuś datę wygaśnięcia dla udostępnień przez link lub e-mail",
    ...
    "If autocompletion restrictions for both \"same group\" and \"phonebook integration\" are enabled, a match in either is enough to show the user." : "Jeśli ograniczenia autouzupełniania dla „tej samej grupy” i „integracji z książką adresową” są włączone, dopasowanie w dowolnym z nich wystarczy, aby pokazać użytkownika.",
    ...
    "Also allow autocompletion on full match of the display name" : "Zezwól również na autouzupełnianie przy pełnym dopasowaniu nazwy wyświetlanej",
    ...
    "All office suites disabled" : "Wszystkie pakiety biurowe wyłączone",
    "{name} enabled" : "{name} włączony",
    ...
    "Unable to update profile picker setting" : "Nie można zaktualizować ustawienia wyboru profilu",
    "Profile" : "Profil",
    "Enable or disable profile by default for new accounts." : "Włącz lub wyłącz profil domyślnie dla nowych kont.",
    "Enable the profile picker" : "Włącz wybór profilu",
    "Enable or disable the profile picker in the Smart Picker and the profile link previews." : "Włącz lub wyłącz wybór profilu w Smart Picker oraz w podglądach linków do profilu",
    ...
    "Bluesky handle" : "Identyfikator Bluesky",
    ...
    "Default config values" : "Domyślne wartości konfiguracji",
    "Applications config" : "Konfiguracja aplikacji",
    "User config" : "Konfiguracja użytkownika",
    "Bundled applications" : "Dołączone aplikacje",
    "Enabled applications" : "Włączone aplikacje",
    "Disabled applications" : "Wyłączone aplikacje",
    "Large organization" : "Duża organizacja",
    "Big organization" : "Wielka organizacja",
    "Small organization" : "Mała organizacja",
    "Hosting company" : "Firma hostingowa",
    "University" : "Uniwersytet",
    "School" : "Szkoła",
    "Club or association" : "Klub lub stowarzyszenie",
    "Family" : "Rodzina",
    "Personal use" : "Użytek osobisty",
    "Setup errors" : "Błędy konfiguracji",
    "Setup warnings" : "Ostrzeżenia konfiguracji",
    "Setup recommendations" : "Rekomendacje konfiguracji",
    ...
    "Loading account …" : "Wczytywanie kont ...",
    ...
    "Email sent successfully" : "Wiadomość e-mail została wysłana pomyślnie",
    "Failed to send email" : "Nie udało się wysłać wiadomości e-mail",
    "Failed to save email settings" : "Nie udało się zapisać ustawień poczty e-mail",
    ...
    "The server configuration is read-only so the mail settings cannot be changed using the web interface." : "Konfiguracja serwera jest tylko do odczytu, dlatego nie można zmienić ustawień poczty e-mail za pomocą interfejsu WWW.",
    "Mail delivery is disabled by instance config \"{config}\"." : "Dostarczanie poczty jest wyłączone w konfiguracji instancji \"{config}\".",
    ...
    "Sending test email…" : "Wysyłanie wiadomości testowej…",
    ...
    "Failed to run setup checks" : "Nie udało się uruchomić kontroli konfiguracji.",
    ...
    "Failed to save selected preset." : "Nie udało się zapisać wybranego ustawienia wstępnego.",
    "Select a configuration preset for easy setup." : "Wybierz ustawienie wstępne konfiguracji dla łatwej instalacji.",
    "Apply" : "Zastosuj",
    ...
    "Follow us on Bluesky" : "Śledź nas na Bluesky",
