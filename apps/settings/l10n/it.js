OC.L10N.register(
    ...
    "An administrator created an app password for a session named \"{token}\"" : "Una amministratore ha creato una password dell'applicazione per una sessione nominata \"{token}\"",
    ...
    "QR Code login" : "Accesso con codice QR",
    ...
    "App directories owner" : "Proprietario cartelle delle applicazioni",
    ...
    "App directories have the correct owner \"%s\"" : "Le cartelle delle applicazioni hanno il proprietario corretto \"%s\"",
    ...
    "Your remote address was identified as \"%s\" and is brute-force throttled at the moment slowing down the performance of various requests. If the remote address is not your address this can be an indication that a proxy is not configured correctly." : "Il tuo indirizzo remoto è stato riconosciuto come \"%s\" ed è al momento obiettivo di un attacco di forza bruta, con conseguente rallentamento delle prestazioni di molte richieste. Se l'indirizzo remoto non è il tuo, questo può essere un'indicazione che un proxy non è configurato correttamente.",
    "Your remote address \"%s\" is not brute-force throttled." : "Il tuo indirizzo remoto \"%s\" non è sottoposto ad attacchi di forza bruta.",
    ...
    "This instance is missing some recommended PHP modules. For improved performance and better compatibility it is highly recommended to install them:\n%s" : "In questa istanza mancano alcuni moduli PHP consigliati. Ti consigliamo vivamente di installarli per garantire prestazioni migliori e una migliore compatibilità:\n%s",
    ...
    "None" : "Nessuno",
    "Changed disclaimer text" : "Testo della clausola modificato",
    ...
    "This will add share permissions to all newly created link shares." : "Questo aggiungerà i permessi di condivisione a tutti i collegamenti condivisi appena creati.",
    ...
    "Exclude some groups" : "Escludi alcuni gruppi",
    "Allow some groups" : "Consenti alcuni gruppi",
    ...
    "Set default expiration date for shares via link or mail" : "Imposta la data di scadenza predefinita per le condivisioni tramite collegamento o posta",
    "Enforce expiration date for link or mail shares" : "Applica la data di scadenza per i collegamenti o le condivisioni via email",
    ...
    "Could not load app discover section" : "Impossibile caricare la sezione di rilevamento delle applicazioni",
    ...
    "Configured ExApp deploy options. Can be set only during installation" : "Opzioni di distribuzione ExApp configurate. Possono essere impostate solo durante l'installazione.",
    ...
    "Cancel encryption" : "Annulla cifratura",
    ...
    "Failed to delete group \"{group}\"" : "Impossibile eliminare il gruppo \"{group}\"",
    ...
    "Disconnect all devices and delete local data" : "Disconnetti tutti i dispositivi ed elimina i dati locali",
    ...
    "If you continue you will still be able to install the app. Note that the app might not work as expected." : "Se continui, potrai comunque installare l'applicazione. Tieni presente che l'applicazione potrebbe non funzionare come previsto.",
    "Unknown" : "Sconosciuto",
    "Never" : "Mai",
