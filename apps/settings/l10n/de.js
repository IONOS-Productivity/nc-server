OC.L10N.register(
    ...
    "Your web server is not properly set up to resolve `.well-known` URLs, failed on:\n`%s`" : "Der Webserver ist nicht ordnungsgemäß für die Auflösung von `.well-known`-URLs eingerichtet. Fehler bei:\n`%s`",
    ...
    "Restrict account name autocompletion to users based on their phonebook" : "Die automatische Vervollständigung von Kontonamen für Benutzer auf deren Telefonbucheinträge beschränken",
    ...
    "Also allow autocompletion on full match of the display name" : "Die automatische Vervollständigung auch bei vollständiger Übereinstimmung mit dem Anzeigenamen zulassen",
    ...
    "The PHP POSIX extension is required. See {linkstart}PHP documentation{linkend} for more details." : "Die PHP-POSIX-Erweiterung ist erforderlich. Weitere Einzelheiten finden sich in der {linkstart}PHP-Dokumentation{linkend}.",
    ...
    "If you continue you will still be able to install the app. Note that the app might not work as expected." : "Wenn du fortfährst, kannst du die App weiterhin installieren. Beachte aber, dass die App möglicherweise nicht wie erwartet funktioniert.",
    "Unknown" : "Unbekannt",
    "Never" : "Niemals",
    ...
    "The app has been enabled but needs to be updated. You will be redirected to the update page in 5 seconds." : "Die App wurde aktiviert, muss aber aktualisiert werden. In 5 Sekunden erfolgt eine Weiterleitung zur Aktualisierungsseite.",
    ...
    "Follow us on Bluesky" : "Folge uns auf Bluesky",
