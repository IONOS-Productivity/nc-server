OC.L10N.register(
    ...
    "None of your tables use ROW_FORMAT=Compressed" : "None of your database tables are using ROW_FORMAT=Compressed",
    "Incorrect row format found in your database. ROW_FORMAT=Dynamic offers the best database performances for Nextcloud. Please update row format on the following list: %s." : "An incorrect row format was detected in your database. ROW_FORMAT=Dynamic provides the best performance for Nextcloud.\nPlease update the row format for the following tables: %s.",
    ...
    "_No scheduled tasks in the last day._::_No scheduled tasks in the last %n days._" : ["No scheduled tasks in the last day.","No scheduled tasks in the last %n days."],
    "_The task pickup speed has been ok in the last day._::_The task pickup speed has been ok in the last %n days._" : ["The task pickup speed has been ok in the last day.","The task pickup speed has been ok in the last %n days."],
    ...
    "_Most tasks were successful in the last day._::_Most tasks were successful in the last %n days._" : ["Most tasks were successful in the last day.","Most tasks were successful in the last %n days."],
    ...
    "Second factor configuration" : "Second factor configuration",
    "This instance has no second factor provider available." : "This instance has no second factor provider available.",
    "Second factor providers are available but two-factor authentication is not enforced." : "Second factor providers are available but two-factor authentication is not enforced.",
    "Second factor providers are available and enforced: %s." : "Second factor providers are available and enforced: %s.",
    ...
    "Exclude some groups" : "Exclude some groups",
    "Allow some groups" : "Allow some groups",
    ...
    "Sharing autocompletion restrictions" : "Sharing autocompletion restrictions",
    "If autocompletion restrictions for both \"same group\" and \"phonebook integration\" are enabled, a match in either is enough to show the user." : "If autocompletion restrictions for both \"same group\" and \"phonebook integration\" are enabled, a match in either is enough to show the user.",
    ...
    "Restrict account name autocompletion to users based on their phonebook" : "Restrict account name autocompletion to users based on their phonebook",
    ...
    "This app has no minimum {productName} version assigned. This will be an error in the future." : "This app has no minimum {productName} version assigned. This will be an error in the future.",
    "This app has no maximum {productName} version assigned. This will be an error in the future." : "This app has no maximum {productName} version assigned. This will be an error in the future.",
    ...
    "{progress}% Initializing …" : "{progress}% Initialising …",
    ...
    "This app is not marked as compatible with your {productName} version." : "This app is not marked as compatible with your {productName} version.",
    "If you continue you will still be able to install the app. Note that the app might not work as expected." : "If you continue you will still be able to install the app. Note that the app might not work as expected.",
    "Unknown" : "Unknown",
    "Never" : "Never",
