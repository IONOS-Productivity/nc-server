OC.L10N.register(
    ...
    "_No scheduled tasks in the last %n hour._::_No scheduled tasks in the last %n hours._" : ["过去 %n 小时内没有计划任务。"],
    "_The task pickup speed has been ok in the last %n hour._::_The task pickup speed has been ok in the last %n hours._" : ["过去 %n 小时内任务领取速度正常。"],
    "_The task pickup speed has been slow in the last %n hour. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._::_The task pickup speed has been slow in the last %n hours. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._" : ["过去 %n 小时内任务领取速度缓慢。许多任务耗时超过 4 分钟才被领取。请考虑设置工作进程在后台处理任务。"],
