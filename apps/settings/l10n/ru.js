OC.L10N.register(
    ...
    "Saved" : "Сохранено",
    "No Login supplied" : "Логин не указан",
    ...
    "Please provide an admin recovery password; otherwise, all account data will be lost." : "Пожалуйста, укажите пароль администратора для восстановления; в противном случае все данные учетной записи будут утеряны.",
    ...
    "Backend does not support password change, but the encryption of the account key was updated." : "Серверная часть не поддерживает смену пароля, но шифрование ключа учетной записи было обновлено.",
    ...
    "Send emails using" : "Отправляйте электронные письма с помощью",
    "User's email account" : "Учетная запись электронной почты пользователя",
    "System email account" : "Системная учетная запись электронной почты",
    "Security & setup checks" : "Проверка безопасности и настроек",
    "Settings presets" : "Настройки предустановок",
    ...
    "List of invalid files…" : "Список недопустимых файлов…",
    ...
    "Mail delivery is disabled by instance config \"%s\"." : "Доставка почты отключена конфигурацией экземпляра \"%s\".",
    ...
    "OCS provider resolving" : "Разрешение поставщика OCS",
    ...
    "You are currently running PHP %1$s. PHP %2$s is deprecated since Nextcloud %3$s. Nextcloud %4$s may require at least PHP %5$s. Please upgrade to one of the officially supported PHP versions provided by the PHP Group as soon as possible." : "В настоящее время вы используете PHP %1$s. PHP %2$s устарел с момента выхода Nextcloud %3$s. Nextcloud %4$s может потребовать как минимум PHP %5$s. Пожалуйста, обновитесь до одной из официально поддерживаемых версий PHP, предоставляемых PHP Group, как можно скорее.",
    ...
    "Database transaction isolation level" : "Уровень изоляции транзакций",
    ...
    "Was not able to get transaction isolation level: %s" : "Не удалось получить уровень изоляции транзакций: %s",
    "Second factor configuration" : "Конфигурация второго фактора",
    "This instance has no second factor provider available." : "В данном случае отсутствует доступный поставщик услуг второй факторизации.",
    "Second factor providers are available but two-factor authentication is not enforced." : "Доступны сервисы, предоставляющие услуги второго фактора аутентификации, но двухфакторная аутентификация не является обязательной.",
    "Second factor providers are available and enforced: %s." : "Доступны и внедрены сервисы второго фактора аутентификации: %s .",
    ".well-known URLs" : "Адреса .well-known",
    "`check_for_working_wellknown_setup` is set to false in your configuration, so this check was skipped." : "`check_for_working_wellknown_setup` в вашей конфигурации установлено значение false, поэтому эта проверка была пропущена.",
    ...
    "Your web server is not properly set up to deliver .{extension} files. This is typically an issue with the Nginx configuration. For Nextcloud 15 it needs an adjustment to also deliver .{extension} files. Compare your Nginx configuration to the recommended configuration in our documentation." : "Ваш веб-сервер неправильно настроен для доставки {extension} файлов . Обычно это проблема конфигурации Nginx. Для Nextcloud 15 требуется настройка, чтобы также доставлять {extension} файлы . Сравните вашу конфигурацию Nginx с рекомендуемой конфигурацией в нашей документации.",
    ...
    "Allow AI usage for guest users" : "Разрешить использование ИИ для гостевых пользователей",
    "Provider for Task types" : "Поставщик типов задач",
    "Enable" : "Включить",
    ...
    "Could not set disclaimer text" : "Не удалось задать текст отказа от отвественности",
    ...
    "Ignore the following groups when checking group membership" : "Игнорировать указанные группы при проверке участия в группе",
    "Allow users to preview files even if download is disabled" : "Разрешить пользователям предварительный просмотр файлов, даже если загрузка отключена",
    "Users will still be able to screenshot or record the screen. This does not provide any definitive protection." : "Пользователи всё равно смогут делать снимки экрана или записывать экран. Это не обеспечивает полной защиты.",
    ...
    "Allow public shares to be added to other clouds by federation." : "Разрешить добавлять публичные ресурсы в другие облака посредством федерации.",
    "This will add share permissions to all newly created link shares." : "Это добавит разрешения на общий доступ ко всем вновь созданным ссылкам общего доступа.",
    ...
    "Exclude some groups" : "Исключить некоторые группы",
    "Allow some groups" : "Разрешить некоторым группам",
    ...
    "Enforce expiration date for remote shares" : "Принудительно задать срок истечения доступа к общим ресурсам с других серверов",
    "Default expiration time of remote shares in days" : "Время истечения общих ресурсов с других серверов по умолчанию (в днях)",
    "Expire remote shares after x days" : "Закрывать общий доступ к ресурсам с других серверов через x дней",
    "Set default expiration date for shares via link or mail" : "Установить срок действия общего доступа через ссылки или почту",
    "Enforce expiration date for link or mail shares" : "Установите срок действия для общих ссылок или почтовых рассылок",
    ...
    "Sharing autocompletion restrictions" : "Ограничения автозаполнения при обмене файлами",
    "If autocompletion restrictions for both \"same group\" and \"phonebook integration\" are enabled, a match in either is enough to show the user." : "Если ограниченя автозаполнения «та же группа» и «интеграция телефонного номера» включены, совпадения в любом из них достаточно, чтобы отобразить пользователя.",
    ...
    "Restrict account name autocompletion to users based on their phonebook" : "Ограничить автоматическое заполнение учетных записей на основе телефонного номера",
    "Allow autocompletion to full match when entering the full name (ignoring restrictions like group membership or missing phonebook match)" : "Разрешить автозаполнение при полном совпадении введённого полного имени (игнорируя ограничения, как членство в группе или отсутствие совпадения в телефонной книге)",
    "Full match autocompletion restrictions" : "Ограничения автозаполнения (полное совпадение)",
    ...
    "Also allow autocompletion on full match of the display name" : "Также разрешить автозаполнение при полном совпадении отображаемого имени.",
    "Also allow autocompletion on full match of the user email" : "Также разрешить автозаполнение при полном совпадении адреса эл.почты пользователя.",
    "Do not use second user displayname for full match" : "Не использовать имя второго пользователя при полном совпадении.",
    ...
    "Show details for {appName} app" : "Подробные сведения о приложении «{appName}»",
    ...
    "Copy login name" : "Копировать имя пользователя",
    "Could not copy app password. Please copy it manually." : "Не удалось скопировать пароль приложения. Скопируйте его вручную.",
    "Could not copy login name. Please copy it manually." : "Не удалось скопировать имя пользователя. Скопируйте его вручную.",
    "New app password" : "Новый пароль приложения",
    "Use the credentials below to configure your app or device. For security reasons this password will only be shown once." : "Для настройки приложения или устройства используйте данных для входа в систему, приведённые ниже. По соображениям безопасности, пароль будет показан только один раз.",
    "Login" : "Логин",
    "Password" : "Пароль",
    ...
    "The cron.php needs to be executed by the system account \"{user}\"." : "Операция cron.php должна выполняться с помощью системной учетной записи \"{user}\".",
    ...
    "AJAX" : "AJAX",
    "Execute one task with each page loaded. Use case: Single account instance." : "Выполняется по одной задаче с каждой загруженной страницей. Пример использования: Один экземпляр учетной записи.",
    "Webcron" : "Webcron",
    ...
    "To encrypt all existing files run this OCC command:" : "Чтобы зашифровать все существующие файлы, выполните следующую команду OCC:",
    "Enable server-side encryption" : "Включить шифрование на стороне сервера",
    "Disabling server side encryption is only possible using OCC, please refer to the documentation." : "Отключение шифрования на стороне сервера возможно только с помощью OCC, см. документацию.",
    ...
    "Cancel encryption" : "Отменить шифрование",
    ...
    "he/him" : "он/его",
    "they/them" : "они/их",
    "Your pronouns. E.g. {pronounsExample}" : "Ваши местоимения. Например: {pronounsExample}",
    "Your role" : "Ваша роль",
    ...
    "Delete" : "Удалить",
    "Reshare" : "Публиковать",
    "Default config values" : "Значения конфигурации по умолчанию",
    "Applications config" : "Конфигурация приложений",
    "User config" : "Конфигурация пользователя",
    "Bundled applications" : "Пакетные приложения",
    "Enabled applications" : "Включенные приложения",
    "Disabled applications" : "Отключенные приложения",
    "Large organization" : "Крупная организация",
    "Big organization" : "Большая организация",
    "Small organization" : "Небольшая организация",
    "Hosting company" : "Хостинговая компания",
    "University" : "Университет",
    "School" : "Школа",
    "Club or association" : "Клуб или ассоциация",
    "Family" : "Семья",
    "Personal use" : "Личное использование",
    "Setup errors" : "Ошибки настройки",
    "Setup warnings" : "Предупреждения о настройке",
    "Setup recommendations" : "Рекомендации по настройке",
    ...
    "Set account as admin for …" : "Назначить пользователя администратором для …",
    "Quota" : "Квота",
    ...
    "Loading account …" : "Загрузка учётной записи …",
    ...
    "Failed to run setup checks" : "Не удалось запустить проверку настроек",
    ...
    "Could not register device: Probably already registered" : "Не удалось зарегистрировать устройство: возможно, это устройство уже зарегистрировано",
    "Could not register device" : "Не удалось зарегистрировать устройство",
    ...
    "Could not delete the app token" : "Не удалось удалить токен приложения",
    ...
    "Follow us on Bluesky" : "Следите за нашими новостями в Bluesky",
