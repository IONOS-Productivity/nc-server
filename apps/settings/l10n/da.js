OC.L10N.register(
    ...
    "Settings presets" : "Forudindstillede indstillinger",
    ...
    "List of invalid files…" : "Liste med ugyldige filer...",
    "Rescan…" : "Genscan...",
    ...
    "Allow users to preview files even if download is disabled" : "Tillad brugere at forhåndsvise filer, selvom download er deaktiveret",
    "Users will still be able to screenshot or record the screen. This does not provide any definitive protection." : "Brugere vil stadig kunne tage screenshot eller optage skærmen. Dette leverer ingen definitiv beskyttelse.",
    ...
    "Request feature" : "Foreslå funktion",
    ...
    "It is important for the security and performance of your instance that everything is configured correctly. To help you with that we are doing some automatic checks. Please see the linked documentation for more information." : "Det er vigtigt af sikkerhedsgrunde og for performance af din instans, at alt er konfigureret korrekt. For at hjælpe dig med dette, så foretager vi nogle automatiske tests. Se venligst den linkede dokumentation for mere information.",
    "Checking your server …" : "Kontrollerer din server ...",
    "Failed to run setup checks" : "Kunne ikke køre opsætningstests",
    "Try again" : "Prøv igen",
    ...
    "Follow us on Bluesky" : "Følg os på Bluesky",
