OC.L10N.register(
    ...
    "One time login" : "Bir kerelik oturum açma",
    "QR Code login" : "Kare kod ile oturum açma",
    ...
    "Send emails using" : "E-postalar şuradan gönderilsin",
    "User's email account" : "Kullanıcının e-posta hesabı",
    "System email account" : "Sistem e-posta hesabı",
    ...
    "List of invalid files…" : "Geçersiz dosyaların listesi…",
    "Rescan…" : "Yeniden tara…",
    ...
    "Logging level configured correctly." : "Günlük düzeyi doğru ayarlanmış.",
    ...
    "Failed to write and read a value from local cache." : "Yerel ön bellekten bir değer yazılamadı ve okunamadı.",
    "Failed to write and read a value from distributed cache." : "Dağıtılmış ön bellekten bir değer yazılamadı ve okunamadı.",
    ...
    "PHP file size upload limit" : "PHP yüklenebilecek dosya boyutu sınırı",
    "The PHP upload_max_filesize is too low. A size of at least %1$s is recommended. Current value: %2$s." : "PHP upload_max_filesize değeri çok küçük. En az %1$s olması önerilir. Geçerli değer: %2$s.",
    "The PHP post_max_size is too low. A size of at least %1$s is recommended. Current value: %2$s." : "PHP post_max_size değeri çok küçük. En az %1$s olması önerilir. Geçerli değer: %2$s.",
    ...
    "Configuration server ID" : "Yapılandırma sunucusu kimliği",
    "Server identifier isn’t configured. It is recommended if your Nextcloud instance is running on several PHP servers. Add a server ID in your configuration." : "Sunucu kimliği yapılandırılmamış. Nextcloud kopyanız birkaç PHP sunucusunda çalışıyorsa önerilir. Yapılandırmanıza bir sunucu kimliği ekleyin.",
    "\"%d\" is not a valid server identifier. It must be between 0 and 1023." : "\"%d\" geçerli bir sunucu kimliği değil. 0 ile 1023 arasında bir değer olmalıdır.",
    "Server identifier is configured and valid." : "Sunucu kimliği yapılandırıldı ve geçerli.",
    ...
    "Nextcloud %d does not support your current version, so be sure to update the database before updating your Nextcloud Server." : "Nextcloud %d geçerli sürümünüzü desteklemiyor. Bu nedenle Nextcloud sunucunuzu güncellemeden önce veri tabanını güncellediğinizden emin olun.",
    "Oracle version \"%1$s\" detected. Oracle >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Oracle \"%1$s\" sürümü algılandı. Bu Nextcloud sürümü ile en iyi başarımı, kararlılığı  ve işlevselliği elde etmek için Oracle sürümünün %2$s ile %3$s arasında olması önerilir.",
    ...
    "_No scheduled tasks in the last day._::_No scheduled tasks in the last %n days._" : ["Son 1 günde zamanlanmış bir görev yok.","Son %n günde zamanlanmış bir görev yok."],
    "_The task pickup speed has been ok in the last day._::_The task pickup speed has been ok in the last %n days._" : ["Son 1 günde zamanlanmış işlenecek görevi alma hızı iyi.","Son %n günde zamanlanmış işlenecek görevi alma hızı iyi."],
    "_The task pickup speed has been slow in the last day. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._::_The task pickup speed has been slow in the last %n days. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._" : ["İşlenecek görevi alma hızı son 1 günde yavaştı. Birçok görevin alınması 4 dakikadan uzun sürdü. Görevlerin arka planda işlenmesi için bir işlem ayarlamayı değerlendirin.","İşlenecek görevi alma hızı son %n günde yavaştı. Birçok görevin alınması 4 dakikadan uzun sürdü. Görevlerin arka planda işlenmesi için bir işlem ayarlamayı değerlendirin."],
    ...
    "Text processing" : "Yazı işleme",
    "Text processing tasks can be implemented by different apps. Here you can set which app should be used for which task." : "Yazı işleme özelliği farklı uygulamalardan sağlanabilir. Buradan, bu görev için hangi uygulamanın kullanılacağını ayarlayabilirsiniz.",
    "Task:" : "Görev:",
    "None of your currently installed apps provide text processing functionality using the Text Processing API." : "Kurulu uygulamaların hiçbirinde Yazı işleme API uygulamasını kullanan bir yazı işleme özelliği yok",
    ...
    "None" : "Yok",
    "Changed disclaimer text" : "Değiştirilmiş sorumluluk reddi yazısı",
    "Deleted disclaimer text" : "Silinmiş sorumluluk reddi yazısı",
    "Could not set disclaimer text" : "Sorumluluk reddi yazısı ayarlanamadı",
    ...
    "Shares with custom tokens will continue to be accessible after this setting has been disabled" : "Bu ayar kapatıldıktan sonra özel kodları olan paylaşımlar erişilebilir olmayı sürdürür",
    ...
    "Restrict account name autocompletion to users based on their phonebook" : "Hesap adlarının telefon defteri bütünleştirmesi eşleşmelerine göre otomatik olarak tamamlanması kısıtlansın",
    "Allow autocompletion to full match when entering the full name (ignoring restrictions like group membership or missing phonebook match)" : "Tam adı yazarken otomatik tamamlamanın tam eşleşmesine izin verilsin (grup üyeliği veya eksik telefon defteri eşleşmesi gibi kısıtlamaları yok sayarak)",
    "Full match autocompletion restrictions" : "Tam eşleşme otomatik tamamlama kısıtlamaları",
    ...
    "Also allow autocompletion on full match of the display name" : "Ayrıca görüntülenecek adın tam eşleşmesinde otomatik tamamlamaya izin verilsin",
    "Also allow autocompletion on full match of the user email" : "Ayrıca kullanıcı e-posta adresinin tam eşleşmesinde otomatik tamamlamaya izin verilsin",
    "Do not use second user displayname for full match" : "Tam eşleşme için ikinci kullanıcı görüntülenecek adı kullanılmasın",
    ...
    "Disclaimer text" : "Sorumluluk reddi yazısı",
    "This text will be shown on the public link upload page when the file list is hidden." : "Dosya listesi gizliyken herkese açık bağlantı yükleme sayfasında görüntülenecek sorumluluk reddi bildirimi yazısı buraya yazabilirsiniz.",
    ...
    "This app has no minimum {productName} version assigned. This will be an error in the future." : "Bu uygulama için en düşük {productName} sürümü belirtilmemiş. Bu durum ileride sorun çıkarır.",
    "This app has no maximum {productName} version assigned. This will be an error in the future." : "Bu uygulama için en yüksek {productName} sürümü belirtilmemiş. Bu durum ileride sorun çıkarır.",
    ...
    "Default config values" : "Varsayılan yapılandırma değerleri",
    "Applications config" : "Uygulamaların yapılandırmaları",
    "User config" : "Kullanıcı yapılandırması",
    "Bundled applications" : "Paketlenmiş uygulamalar",
    "Enabled applications" : "Kullanıma alınmış uygulamalar",
    "Disabled applications" : "Kullanıma alınmamış uygulamalar",
    "Large organization" : "Çok büyük kuruluş",
    "Big organization" : "Büyük kuruluş",
    "Small organization" : "Küçük kuruluş",
    ...
    "Setup warnings" : "Kurulum uyarıları",
    "Setup recommendations" : "Kurulum önerileri",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the {productName} data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Aygıt kaybedildiğinde ya da kuruluş ile çalışma sona erdirildiğinde, bu özellik {userid} ile ilişkili tüm aygıtlardaki {productName} verilerini silebilir. Bu özellik yalnızca aygıtların internet bağlantısı olduğunda kullanılabilir.",
    ...
    "Email sent successfully" : "E-posta gönderildi",
    "Failed to send email" : "E-posta gönderilemedi",
    "Failed to save email settings" : "E-posta ayarları kaydedilemedi",
    ...
    "Sending test email…" : "Deneme e-postası gönderiliyor…",
    "Send test email" : "Deneme e-postası gönder",
    "Saving…" : "Kaydediliyor…",
    "Save settings" : "Ayarları kaydet",
    "Please double check the {linkStartInstallationGuides}installation guides{linkEnd}, and check for any errors or warnings in the {linkStartLog}log{linkEnd}." : "Lütfen {linkStartInstallationGuides}kurulum rehberlerini{linkEnd} yeniden gözden geçirin ve {linkStartLog}günlük kayıtlarındaki{linkEnd} hata ve uyarılara bakın.",
    "Check the security of your {productName} over {linkStart}our security scan{linkEnd}." : "{linkStart}Güvenlik sınamamızdan{linkEnd} geçirerek {productName} güvenliğinizi denetleyin.",
    "Security & setup warnings" : "Güvenlik ve kurulum uyarıları",
    "It is important for the security and performance of your instance that everything is configured correctly. To help you with that we are doing some automatic checks. Please see the linked documentation for more information." : "Kopyanızın güvenli ve yüksek başarımla çalışması için ayarların doğru yapılmış olması önemlidir. Bunu sağlamak için bazı otomatik denetimler yapılır. Ayrıntılı bilgi almak için İpuçları bölümüne ve belgelere bakın.",
    "Checking your server …" : "Sunucunuz denetleniyor…",
    "Failed to run setup checks" : "Kurulum demetimleri yapılamadı",
    ...
    "Failed to save selected preset." : "Seçilmiş hazır ayar kaydedilemedi.",
    "Select a configuration preset for easy setup." : "Kolay kurulum için bir hazır yapılandırma seçin.",
    "Apply" : "Uygula",
    "All accounts" : "Tüm hesaplar",
    "Admins" : "Yöneticiler",
    "Account group: {group}" : "Hesap grubu: {group}",
    "Account management" : "Hesap yönetimi",
    "For performance reasons, when you enable encryption on a {productName} server only new and changed files are encrypted." : "Bir {productName} sunucusunda şifrelemeyi açtığınızda, başarımı korumak için yalnızca yeni ve değiştirilen dosyalar şifrelenir.",
    "Location" : "Konum",
    ...
    "This app is not marked as compatible with your {productName} version." : "Bu uygulamanın kullandığınız {productName} sürümü ile uyumluluğu denetlenmemiş. ",
    "If you continue you will still be able to install the app. Note that the app might not work as expected." : "İşlemi sürdürerek uygulamayı kurabilirsiniz. Ancak uygulama beklendiği gibi çalışmayabilir.",
    "Unknown" : "Bilinmiyor",
    "Never" : "Asla",
    ...
    "Follow us on Bluesky" : "Bizi Bluesky üzerinde izleyin",
