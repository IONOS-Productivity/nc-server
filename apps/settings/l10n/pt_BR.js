OC.L10N.register(
    ...
    "One time login" : "Login único",
    "QR Code login" : "Login com código QR",
    ...
    "Transactional File Locking" : "Trancamento de Arquivo Transacional",
    ...
    "The database is used for transactional file locking. To enhance performance, please configure memcache, if available." : "O banco de dados é usado para trancamento de arquivo transacional. Para melhorar o desempenho, configure o memcache, se disponível.",
    ...
    "Also allow autocompletion on full match of the display name" : "Permitir também o preenchimento automático em caso de correspondência completa do nome de exibição",
    ...
    "User config" : "Configuração do usuário",
    "Bundled applications" : "Aplicativos incluídos",
    "Enabled applications" : "Aplicativos ativados",
    "Disabled applications" : "Aplicativos desativados",
    "Large organization" : "Organização muito grande",
    "Big organization" : "Organização grande",
    "Small organization" : "Organização pequena",
    "Hosting company" : "Empresa de hospedagem",
    "University" : "Universidade",
    "School" : "Escola",
    "Club or association" : "Clube ou associação",
    "Family" : "Família",
    "Personal use" : "Uso pessoal",
    "Setup errors" : "Erros de instalação",
    "Setup warnings" : "Avisos de instalação",
    ...
    "Failed to save email settings" : "Falha ao salvar as configurações de e-mail",
    ...
    "Sending test email…" : "Enviando e-mail de teste…",
