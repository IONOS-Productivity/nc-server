OC.L10N.register(
    ...
    "Settings presets" : "Předdefinovaná nastavení",
    ...
    "List of invalid files…" : "Vypsat neplatné soubory …",
    "Rescan…" : "Proskenovat znovu …",
    ...
    "_The task pickup speed has been ok in the last day._::_The task pickup speed has been ok in the last %n days._" : ["Rychlost vyzvedávání úkolů byla ok za uplynulý den.","Rychlost vyzvedávání úkolů byla ok za uplynulé %n dny.","Rychlost vyzvedávání úkolů byla ok za uplynulých %n dnů.","Rychlost vyzvedávání úkolů byla ok za uplynulé %n dny."],
    ...
    "_A lot of tasks failed in the last day. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly._::_A lot of tasks failed in the last %n days. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly._" : ["V uplynulém dni se nezdařilo mnoho úloh. Zvažte kontrolu záznamů událostí v Nextcloud ohledně chyb a prošetření, zda aplikace poskytovatele AI byly správně nastaveny.","V uplynulých %n dnech se nezdařilo mnoho úloh. Zvažte kontrolu záznamů událostí v Nextcloud ohledně chyb a prošetření, zda aplikace poskytovatele AI byly správně nastaveny.","V uplynulých %n dnech se nezdařilo mnoho úloh. Zvažte kontrolu záznamů událostí v Nextcloud ohledně chyb a prošetření, zda aplikace poskytovatele AI byly správně nastaveny.","V uplynulých %n dnech se nezdařilo mnoho úloh. Zvažte kontrolu záznamů událostí v Nextcloud ohledně chyb a prošetření, zda aplikace poskytovatele AI byly správně nastaveny."],
    ...
    "Provider for Task types" : "Poskytovatel typů úkolů",
    "Enable" : "Zapnout",
    ...
    "Exclude some groups" : "Vynechat některé skupiny",
    "Allow some groups" : "Povolit některé skupiny",
    ...
    "Bluesky handle" : "Identifikátor (handle) na Bluesky",
    ...
    "Default config values" : "Výchozí hodnoty nastavení",
    "Applications config" : "Nastavení aplikací",
    "User config" : "Nastavení uživatele",
    "Bundled applications" : "Aplikace, které jsou součástí výchozí instalace",
    "Enabled applications" : "Zapnuté aplikace",
    "Disabled applications" : "Vypnuté aplikace",
    "Large organization" : "Rozsáhlá organizace",
    "Big organization" : "Velká organizace",
    "Small organization" : "Malá organizace",
    "Hosting company" : "Společnost, poskytující hosting",
    "University" : "Univerzita",
    "School" : "Škola",
    "Club or association" : "Klub či sdružení",
    "Family" : "Rodina",
    "Personal use" : "Osobní použití",
    "Setup errors" : "Chyby v nastavení",
    "Setup warnings" : "Varování ohledně nastavení",
    "Setup recommendations" : "Doporučení ohledně nastavení",
    ...
    "Sending test email…" : "Posílání testovacího e-mailu…",
