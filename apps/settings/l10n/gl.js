OC.L10N.register(
    ...
    "One time login" : "Acceso único",
    "QR Code login" : "Acceso con código QR",
    ...
    "Backend does not support password change, but the encryption of the account key was updated." : "A infraestrutura non admite o cambio de contrasinal, mais a chave de cifraxe da conta foi actualizada.",
    ...
    "Your Login is: %s" : "O seu acceso é: %s",
    "Set your password" : "Defina o seu contrasinal",
    "Go to %s" : "Ira a %s",
    "Install Client" : "Instalar o cliente",
    "Logged in account must be a sub admin" : "A conta que accede debe ser de subadministración",
    "Apps" : "Aplicacións",
    "Personal" : "Persoal",
    ...
    "List of invalid files…" : "Lista de ficheiros non válidos…",
    "Rescan…" : "Volver analizar…",
    ...
    "Old server-side-encryption" : "Antiga cifraxe no lado do servidor",
    "Disabled" : "Desactivado",
    "The old server-side-encryption format is enabled. We recommend disabling this." : "O antigo formato de cifraxe do lado do servidor está activado. Recomendámoslle desactivalo.",
    "Logging level" : "Nivel de rexistro",
    "The %1$s configuration option must be a valid integer value." : "A opción de configuración %1$s debe ser un valor enteiro válido.",
    "The logging level is set to debug level. Use debug level only when you have a problem to diagnose, and then reset your log level to a less-verbose level as it outputs a lot of information, and can affect your server performance." : "O nivel de rexistro está definido no nivel de depuración. Empregue o nivel de depuración só cando teña un problema para diagnosticar e, a continuación, restabeleza o nivel de rexistro a un nivel menos detallado xa que emite moita información e pode afectar ao rendemento do servidor.",
    "Logging level configured correctly." : "O nivel de rexistro foi configurado correctamente.",
    ...
    "Scheduling objects table size is within acceptable range." : "O tamaño da táboa de obxectos de planificación está dentro do intervalo aceptábel.",
    ...
    "Second factor providers are available but two-factor authentication is not enforced." : "Hai provedores de segundo factor dispoñíbeis, mais non é obrigatoria a autenticación de dous factores.",
    "Second factor providers are available and enforced: %s." : "Os provedores de segundo factor están dispoñíbeis e é obrigatorio: %s",
    ...
    "Also allow autocompletion on full match of the display name" : "Permitir tamén o autocompletado cando coincida totalmente co nome para amosar",
    ...
    "Unable to update server side encryption config" : "Non é posíbel actualizar a configuración de cifraxe do servidor",
    "Server-side encryption" : "Cifraxe no lado do servidor",
    "Server-side encryption makes it possible to encrypt files which are uploaded to this server. This comes with limitations like a performance penalty, so enable this only if needed." : "A cifraxe do lado do servidor fai posíbel cifrar os ficheiros que van ser enviados a este servidor. Isto leva algunhas limitacións como penalizacións no rendemento, así que actíveo só se é necesario.",
    "To encrypt all existing files run this OCC command:" : "Para cifrar todos os ficheiros existentes execute esta orde OCC:",
    "Enable server-side encryption" : "Activar a cifraxe no lado do servidor",
    "Disabling server side encryption is only possible using OCC, please refer to the documentation." : "Desactivar a cifraxe do lado do servidor só é posíbel empregando OCC, consulte a documentación.",
    "No encryption module loaded, please enable an encryption module in the app menu." : "Non hai cargado ningún módulo de cifraxe, active un módulo de cifraxe no menú de aplicacións.",
    "Select default encryption module:" : "Seleccionar o módulo predeterminado de cifraxe:",
    "You need to migrate your encryption keys from the old encryption (ownCloud <= 8.0) to the new one. Please enable the \"Default encryption module\" and run {command}" : "É necesario migrar as súas chave de cifraxe da antiga cifraxe (ownCloud <= 8,0) cara ao novo. Active o «Módulo predeterminado de cifraxe» e execute {command}",
    "Cancel encryption" : "Cancelar a cifraxe",
    "Enable encryption" : "Activar a cifraxe",
    "Confirm enabling encryption" : "Confirmar a activación da cifraxe",
    "Please read carefully before activating server-side encryption:" : "Lea atentamente antes de activar a cifraxe no lado do servidor:",
    "Once encryption is enabled, all files uploaded to the server from that point forward will be encrypted at rest on the server. It will only be possible to disable encryption at a later date if the active encryption module supports that function, and all pre-conditions (e.g. setting a recover key) are met." : "Una vez que a cifraxe estea activada, todos os ficheiros enviados ao servidor desde ese punto en diante cifraranse en repouso no servidor. Só será posíbel desactivar a cifraxe nunha data posterior se o módulo de cifraxe activado admite esa función, e se cumpran todas as condicións previas (por exemplo, o axuste dunha chave de recuperación).",
    "By default a master key for the whole instance will be generated. Please check if that level of access is compliant with your needs." : "De xeito predeterminado xerarase unha chave mestra para toda a instancia. Comprobe se ese nivel de acceso cumpre coas súas necesidades.",
    "Encryption alone does not guarantee security of the system. Please see documentation for more information about how the encryption app works, and the supported use cases." : "A cifraxe por si soa non garante a seguranza do sistema. Vexa a documentación para obter máis información sobre como funciona a aplicación de cifraxe e os casos de uso admitidos.",
    "Be aware that encryption always increases the file size." : "Teña presente que a cifraxe sempre incrementa o tamaño do ficheiro.",
    "It is always good to create regular backups of your data, in case of encryption make sure to backup the encryption keys along with your data." : "Sempre é  bo crear copias de seguranza dos seus datos, no caso da cifraxe, asegúrese de ter unha copia de seguranza das chaves de cifraxe xunto cos seus datos.",
    ...
    "This is the final warning: Do you really want to enable encryption?" : "Esta é a última advertencia: Confirma que quere activar a cifraxe?",
    ...
    "User config" : "Configuración do usuario",
    "Bundled applications" : "Aplicacións incluídas",
    "Enabled applications" : "Aplicacións activadas",
    "Disabled applications" : "Aplicacións desactivadas",
    "Large organization" : "Gran organización",
    "Big organization" : "Organización importante",
    "Small organization" : "Pequena organización",
    "Hosting company" : "Empresa de aloxamento web",
    "University" : "Universidade",
    "School" : "Escola",
    "Club or association" : "Club ou asociación",
    "Family" : "Familia",
    "Personal use" : "Uso persoal",
    "Setup errors" : "Erros de configuración",
    "Setup warnings" : "Advertencias de configuración",
    ...
    "This app is not marked as compatible with your {productName} version." : "Esta aplicación non está marcada como compatíbel coa súa versión de {productName}.",
    "If you continue you will still be able to install the app. Note that the app might not work as expected." : "Se continúa, poderá instalar a aplicación. Teña en conta que é probábel que a aplicación non funcione como se agarda.",
    "Unknown" : "Descoñecido",
    "Never" : "Nunca",
