OC.L10N.register(
    ...
    "One time login" : "Logáil isteach aonuaire",
    "QR Code login" : "Logáil isteach Cód QR",
    ...
    "Logged in account must be a sub admin" : "Ní mór gur fo-riarthóir é cuntas logáilte isteach",
    "Apps" : "Feidhmchláir",
    "Personal" : "Pearsanta",
    ...
    "Settings presets" : "Réamhshocruithe socruithe",
    ...
    "You are currently running PHP %1$s. PHP %2$s is deprecated since Nextcloud %3$s. Nextcloud %4$s may require at least PHP %5$s. Please upgrade to one of the officially supported PHP versions provided by the PHP Group as soon as possible." : "Tá PHP %1$s á rith agat faoi láthair. Tá PHP %2$s astaithe ó Nextcloud %3$s. Seans go mbeidh PHP %5$s ar a laghad ag teastáil ó Nextcloud %4$s. Uasghrádaigh go dtí ceann de na leaganacha PHP a bhfuil tacaíocht oifigiúil acu a chuir an Grúpa PHP ar fáil chomh luath agus is féidir.",
    ...
    "Exclude some groups" : "Eisiamh roinnt grúpaí",
    "Allow some groups" : "Ceadaigh roinnt grúpaí",
    ...
    "Failed to load groups" : "Theip ar lódáil na ngrúpaí",
    ...
    "List of groups. This list is not fully populated for performance reasons. The groups will be loaded as you navigate or search through the list." : "Liosta grúpaí. Níl an liosta seo lándaite ar chúiseanna feidhmíochta. Déanfar na grúpaí a luchtú agus tú ag nascleanúint nó ag cuardach tríd an liosta.",
    ...
    "To encrypt all existing files run this OCC command:" : "Rith an t-ordú OCC seo chun gach comhad atá ann cheana a chriptiú:",
    "Enable server-side encryption" : "Cumasaigh criptiú taobh an fhreastalaí",
    "Disabling server side encryption is only possible using OCC, please refer to the documentation." : "Ní féidir criptiú taobh an fhreastalaí a dhíchumasú ach trí OCC a úsáid, féach le do thoil ar an gcáipéisíocht.",
    ...
    "Cancel encryption" : "Cealaigh an criptiú",
    "Enable encryption" : "Cumasaigh criptiú",
    "Confirm enabling encryption" : "Deimhnigh criptiú cumasaithe",
    ...
    "By default a master key for the whole instance will be generated. Please check if that level of access is compliant with your needs." : "De réir réamhshocraithe ginfear máistireochair don ásc iomlán. Seiceáil le do thoil an gcomhlíonann an leibhéal rochtana sin do chuid riachtanas.",
    ...
    "Email sent successfully" : "Seoladh an ríomhphost go rathúil",
    "Failed to send email" : "Theip ar ríomhphost a sheoladh",
    "Failed to save email settings" : "Theip ar shocruithe ríomhphoist a shábháil",
    ...
    "The server configuration is read-only so the mail settings cannot be changed using the web interface." : "Is inléite amháin atá cumraíocht an fhreastalaí agus mar sin ní féidir na socruithe ríomhphoist a athrú ag baint úsáide as an gcomhéadan gréasáin.",
    "Mail delivery is disabled by instance config \"{config}\"." : "Tá seachadadh ríomhphoist díchumasaithe ag cumraíocht an sampla \"{config}\".",
    ...
    "Sending test email…" : "Ag seoladh ríomhphoist tástála…",
    ...
    "Failed to save selected preset." : "Theip ar an réamhshocrú roghnaithe a shábháil.",
    "Select a configuration preset for easy setup." : "Roghnaigh réamhshocrú cumraíochta le haghaidh thus éasca.",
    ...
    "This app is not marked as compatible with your {productName} version." : "Níl an aip seo marcáilte mar aip atá comhoiriúnach le do leagan de {productName}.",
    "If you continue you will still be able to install the app. Note that the app might not work as expected." : "Má leanann tú ar aghaidh beidh tú fós in ann an aip a shuiteáil. Tabhair faoi deara go bhféadfadh sé nach n-oibreoidh an aip mar a bhíothas ag súil leis.",
    "Unknown" : "Anaithnid",
    "Never" : "Riamh",
