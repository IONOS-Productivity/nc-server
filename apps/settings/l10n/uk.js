OC.L10N.register(
    ...
    "One time login" : "Одноразовий вхід",
    "QR Code login" : "Вхід за допомогою коду QR",
    ...
    "Recently active" : "Нещодавно активний",
    ...
    "Server identifier isn’t configured. It is recommended if your Nextcloud instance is running on several PHP servers. Add a server ID in your configuration." : "Ідентифікатор сервера не налагтовано. Рекомендується додати ID сервера до конфігурації, якщо ваш примірник хмари Nextcloud розгорнуто на кількох серверах PHP.",
    ...
    "Server identifier is configured and valid." : "Ідентифікатор сервера налаштовано, є дійсним.",
    ...
    "_The task pickup speed has been ok in the last day._::_The task pickup speed has been ok in the last %n days._" : ["Швидкість виконання завдань була задовільною за останній день.","Швидкість виконання завдань була задовільною за останні %n дні.","Швидкість виконання завдань була задовільною за останні %n днів.","Швидкість виконання завдань була задовільною за останні %n днів."],
    "_The task pickup speed has been slow in the last day. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._::_The task pickup speed has been slow in the last %n days. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._" : ["Швидкість виконання завдань була уповільненою за останній день. Завдання виконувалися із затримкою понад 4 хв. Рекомендується налаштувати обробник завдань для виконання на задньому фоні.","Швидкість виконання завдань була уповільненою за останні %n дні. Завдання виконувалися із затримкою понад 4 хв. Рекомендується налаштувати обробник завдань для виконання на задньому фоні.","Швидкість виконання завдань була уповільненою за останні %n днів. Завдання виконувалися із затримкою понад 4 хв. Рекомендується налаштувати обробник завдань для виконання на задньому фоні.","Швидкість виконання завдань була уповільненою за останні %n днів. Завдання виконувалися із затримкою понад 4 хв. Рекомендується налаштувати обробник завдань для виконання на задньому фоні."],
    "_Most tasks were successful in the last day._::_Most tasks were successful in the last %n days._" : ["Більшість завдань було успішно виконано протягом останнього дня.","Більшість завдань було успішно виконано протягом останніх %n днів.","Більшість завдань було успішно виконано протягом останніх %n днів.","Більшість завдань було успішно виконано протягом останніх %n днів."],
    "_A lot of tasks failed in the last day. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly._::_A lot of tasks failed in the last %n days. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly._" : ["Багато завдань не було успішно виконано протягом останнього дня. Перегляньте журнал помилок Nextcloud та перевірте, чи застосунки постачальника послуг ШІ налаштовано правильно.","Багато завдань не було успішно виконано протягом %n днів. Перегляньте журнал помилок Nextcloud та перевірте, чи застосунки постачальника послуг ШІ налаштовано правильно.","Багато завдань не було успішно виконано протягом %n днів. Перегляньте журнал помилок Nextcloud та перевірте, чи застосунки постачальника послуг ШІ налаштовано правильно.","Багато завдань не було успішно виконано протягом %n днів. Перегляньте журнал помилок Nextcloud та перевірте, чи застосунки постачальника послуг ШІ налаштовано правильно."],
    ...
    "Allow some groups" : "Дозволити окремі групи",
    ...
    "Web, desktop and mobile clients currently logged in to your account." : "Вебсайт, настільний клієнт або мобільні застосунки, до яких ви зараз увійшли.",
    "Error while creating device token" : "Помилка під час створення токена пристрою",
    "App name" : "Зазначте назву застосунку",
    "Create new app password" : "Додати новий пароль застосунку",
    ...
    "Change" : "Змінити",
    "Delete" : "Вилучати",
    "Reshare" : "Надавати у спільний доступ",
    ...
    "Email sent successfully" : "Ел. повідомлення успішно надіслано",
    "Failed to send email" : "Не вдалося надіслати ел. повідомлення",
    "Failed to save email settings" : "Не вдалося зберегти налаштування ел. пошти",
    ...
    "The server configuration is read-only so the mail settings cannot be changed using the web interface." : "Параметри налаштувань сервера в режимі читання, тому неможливо змінити налаштування пошти за допомогою вебінтерфейсу.",
    "Mail delivery is disabled by instance config \"{config}\"." : "Надсилання ел. повідомлень вимкнено у налаштуваннях примірника \"{config}\".",
    ...
    "Health checking" : "Перевірка доступності",
