OC.L10N.register(
    ...
    "One time login" : "Einmalanmeldung",
    "QR Code login" : "QR-Code-Anmeldung",
    ...
    "Email could not be sent. Check your mail server log" : "E-Mail konnte nicht versandt werden. Prüfen Sie Ihr E-Mail-Serverprotokoll",
    ...
    "Your password on %s was reset by an administrator." : "Ihr Passwort auf %s wurde von der Administration zurückgesetzt.",
    ...
    "If you did not request this, please contact an administrator." : "Wenn Sie das nicht angefordert haben sollten, wenden Sie sich bitte an die Administration.",
    ...
    "Settings presets" : "Einstellungsvorgaben",
    ...
    "This instance is running in debug mode. Only enable this for local development and not in production environments." : "Diese Instanz wird im Debug-Modus ausgeführt. Aktivieren Sie dies nur zum Zwecke der lokalen Entwicklung und nicht in Produktivumgebungen.",
    ...
    "Your \"trusted_proxies\" setting is not correctly set, it should be an array of IP addresses - optionally with range in CIDR notation." : "Ihre \"trusted_proxies\"-Einstellung ist nicht richtig eingestellt, es sollte ein Array von IP-Adressen sein – optional mit einem Bereich in CIDR-Notation.",
    ...
    "The logging level is set to debug level. Use debug level only when you have a problem to diagnose, and then reset your log level to a less-verbose level as it outputs a lot of information, and can affect your server performance." : "Die Protokollierungsstufe ist auf Debug eingestellt. Verwenden Sie die Debugstufe nur, wenn Sie ein Problem diagnostizieren müssen, und setzen Sie die Protokollierungsstufe dann auf eine weniger ausführliche Stufe zurück, da sie viele Informationen ausgibt und die Leistung Ihres Servers beeinträchtigen kann.",
    ...
    "_No scheduled tasks in the last day._::_No scheduled tasks in the last %n days._" : ["Keine geplanten Aufgaben am vergangenen Tag.","Keine geplanten Aufgaben in den letzten %n Tagen."],
    ...
    "Could not check for {extension} loading support. Please check manually if your webserver serves `.{extension}` files." : "Es konnte nicht geprüft werden, ob Ladeunterstützung für {extension} vorhanden ist. Bitte prüfen Sie manuell, ob Ihr Webserver `.{extension}`-Dateien bereitstellt.",
    "Your web server is not properly set up to deliver .{extension} files. This is typically an issue with the Nginx configuration. For Nextcloud 15 it needs an adjustment to also deliver .{extension} files. Compare your Nginx configuration to the recommended configuration in our documentation." : "Ihr Webserver ist nicht richtig eingerichtet, um .{extension}-Dateien auszuliefern. Dies ist normalerweise ein Problem mit der Nginx-Konfiguration. Für Nextcloud 15 muss eine Anpassung vorgenommen werden, um auch .{extension}-Dateien auszuliefern. Vergleichen Sie Ihre Nginx-Konfiguration mit der empfohlenen Konfiguration in unserer Dokumentation.",
    ...
    "Exclude groups from creating link shares" : "Gruppen von der Erstellung von Linkfreigaben ausschließen",
    ...
    "Full match autocompletion restrictions" : "Einschränkungen bei der automatischen Vervollständigung vollständiger Übereinstimmungen",
    ...
    "Also allow autocompletion on full match of the display name" : "Automatische Vervollständigung auch bei vollständiger Übereinstimmung mit dem Anzeigenamen zulassen",
    ...
    "Two-factor authentication can be enforced for all accounts and specific groups. If they do not have a two-factor provider configured, they will be unable to log into the system." : "Zwei-Faktor-Authentifizierung kann für alle Konten und spezifische Gruppen erzwungen werden. Wenn sie keinen Anbieter für Zwei-Faktor-Authentifizierung konfiguriert haben, können sie sich nicht am System anmelden.",
    ...
    "Two-factor authentication is enforced for all members of the following groups." : "Zwei-Faktor-Authentifizierung wird für alle Konten der folgenden Gruppen erzwungen.",
    "Enforced groups" : "Erzwungene Gruppen",
    "Two-factor authentication is not enforced for members of the following groups." : "Zwei-Faktor-Authentifizierung wird für Konten der folgenden Gruppen nicht erzwungen.",
    "Excluded groups" : "Ausgeschlossene Gruppen",
    "When groups are selected/excluded, they use the following logic to determine if an account has 2FA enforced: If no groups are selected, 2FA is enabled for everyone except members of the excluded groups. If groups are selected, 2FA is enabled for all members of these. If an account is both in a selected and excluded group, the selected takes precedence and 2FA is enforced." : "Bei der Auswahl/Abwahl von Gruppen wird folgende Logik verwendet, um festzustellen, ob ein Konto 2FA verwenden muss: Wenn keine Gruppe ausgewählt ist, dann wird 2FA für alle Konten aktiviert, außer für Konten der ausgenommenen Gruppen. Sind Gruppen ausgewählt, so wird 2FA für alle Konten dieser Gruppen aktiviert. Ist ein Konto sowohl in einer ausgewählten als auch in einer ausgenommenen Gruppe, so hat die Auswahl Vorrang und 2FA wird aktiviert.",
    ...
    "Register a custom one or setup from available templates" : "Eine benutzerdefinierte Vorlage registrieren oder aus einer der verfügbaren Vorlagen einrichten",
    ...
    "Admin documentation" : "Anleitung für die Administration",
    ...
    "This app has no minimum {productName} version assigned. This will be an error in the future." : "Für diese App wurde keine untere Versionsgrenze für {productName} gesetzt. Dies wird künftig als Fehler behandelt.",
    ...
    "Use the credentials below to configure your app or device. For security reasons this password will only be shown once." : "Verwenden Sie die unten stehenden Anmeldeinformationen, um Ihre App oder Ihr Gerät zu konfigurieren. Aus Sicherheitsgründen wird dieses Passwort nur einmal angezeigt.",
    "Login" : "Anmelden",
    "Password" : "Passwort",
    ...
    "To encrypt all existing files run this OCC command:" : "Um alle vorhandenen Dateien zu verschlüsseln, führen Sie diesen OCC-Befehl aus:",
    "Enable server-side encryption" : "Serverseitige Verschlüsselung aktivieren",
    "Disabling server side encryption is only possible using OCC, please refer to the documentation." : "Das Deaktivieren der serverseitigen Verschlüsselung ist nur mit OCC möglich, bitte beachten Sie die Dokumentation.",
    ...
    "This is the final warning: Do you really want to enable encryption?" : "Dies ist die letzte Warnung: Soll die Verschlüsselung aktiviert werden?",
    ...
    "Default config values" : "Standardkonfigurationswerte",
    "Applications config" : "Anwendungskonfiguration",
    "User config" : "Benutzerkonfiguration",
    "Bundled applications" : "Gebündelte Anwendungen",
    ...
    "School" : "Schule",
    "Club or association" : "Verein oder Gemeinschaft",
    "Family" : "Familie",
    "Personal use" : "Persönlicher Gebrauch",
    "Setup errors" : "Einrichtungsfehler",
    "Setup warnings" : "Einrichtungswarnungen",
    "Setup recommendations" : "Einrichtungsempfehlungen",
    ...
    "Email sent successfully" : "E-Mail wurde versandt",
    "Failed to send email" : "E-Mail konnte nicht versandt werden",
    "Failed to save email settings" : "E-Mail-Einstellungen konnten nicht gespeichert werden",
    ...
    "The server configuration is read-only so the mail settings cannot be changed using the web interface." : "Die Serverkonfiguration ist schreibgeschützt, sodass die E-Mail-Einstellungen nicht über die Web-Oberfläche geändert werden können.",
    "Mail delivery is disabled by instance config \"{config}\"." : "Die E-Mail-Zustellung ist aufgrund der Instanzkonfiguration \"{config}\" deaktiviert.",
    ...
    "Failed to save selected preset." : "Ausgewählte Voreinstellungen konnten nicht gespeichert werden.",
    "Select a configuration preset for easy setup." : "Konfigurationsvoreinstellung für eine einfache Einrichtung auswählen.",
    "Apply" : "Anwenden",
    ...
    "This app is not marked as compatible with your {productName} version." : "Diese App ist nicht als kompatibel mit dieser {productName}-Version gekennzeichnet.",
    "If you continue you will still be able to install the app. Note that the app might not work as expected." : "Wenn Sie fortfahren, können Sie die App weiterhin installieren. Beachten Sie aber, dass die App möglicherweise nicht wie erwartet funktioniert.",
    "Unknown" : "Unbekannt",
    "Never" : "Niemals",
    ...
    "Do you really want to wipe your data from this device?" : "Sollen alle Daten von diesem Gerät gelöscht werden?",
