OC.L10N.register(
    ...
    "Sharing autocompletion restrictions" : "自動補完の制限事項の共有",
    ...
    "Delete" : "削除",
    "Reshare" : "再共有",
    "Default config values" : "デフォルト設定値",
    "Applications config" : "アプリケーション設定",
    "User config" : "ユーザー設定",
    "Bundled applications" : "バンドルされたアプリケーション",
    "Enabled applications" : "有効なアプリケーション",
    "Disabled applications" : "無効化されたアプリケーション",
    "Large organization" : "大規模組織",
    "Big organization" : "大きな組織",
    "Small organization" : "小さな組織",
    "Hosting company" : "ホスティング会社",
    "University" : "大学",
    "School" : "学校",
    "Club or association" : "クラブまたは協会",
    "Family" : "家族",
    "Personal use" : "個人使用",
    "Setup errors" : "設定エラー",
