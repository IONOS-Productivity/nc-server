OC.L10N.register(
    ...
    "QR Code login" : "Prihlásenie pomocou QR kódu",
    ...
    "Mail Providers" : "Poskytovatelia e-mailu",
    ...
    "The %1$s configuration option must be a valid integer value." : "Voľba %1$s v nastaveniach musí byť platné číslo.",
    "The logging level is set to debug level. Use debug level only when you have a problem to diagnose, and then reset your log level to a less-verbose level as it outputs a lot of information, and can affect your server performance." : "Úroveň protokolovania je nastavená na úroveň ladenia. Úroveň ladenia použite len vtedy, keď máte problém s diagnostikou, a potom resetujte úroveň svojho protokolu na menej podrobnú úroveň, pretože poskytuje množstvo informácií a môže ovplyvniť výkon vášho servera.",
    "Logging level configured correctly." : "Úroveň protokolovania bol správne nastavený.",
    ...
    "Failed to write and read a value from local cache." : "Nepodarilo sa prečítať a zapísať hodnotu z lokálnej vyrovnávacej pamäte.",
    "Failed to write and read a value from distributed cache." : "Nepodarilo sa prečítať a zapísať hodnotu z distribuovanej vyrovnávacej pamäte.",
    ...
    "None of your tables use ROW_FORMAT=Compressed" : "Žiadna vaša tabuľka nepoužíva ROW_FORMAT=Compressed",
    "Incorrect row format found in your database. ROW_FORMAT=Dynamic offers the best database performances for Nextcloud. Please update row format on the following list: %s." : "V databáze sa našiel nesprávny formát riadkov. ROW_FORMAT=Dynamic ponúka najlepší výkon databázy pre Nextcloud. Aktualizujte formát riadkov v nasledujúcom zozname: %s.",
    ...
    "Your APCu cache has been running full, consider increasing the apc.shm_size php setting." : "Vaša vyrovnávacia pamäť APCu je plná, zvážte zvýšenie nastavenia apc.shm_size php.",
    "Your APCu cache is almost full at %s%%, consider increasing the apc.shm_size php setting." : " Vaša vyrovnávacia pamäť APCu je skoro plná na %s %%:\", zvážte zvýšenie nastavenia apc.shm_size php.",
    ...
    "PHP file size upload limit" : "Limit veľkosti súboru PHP pre nahratie",
    "The PHP upload_max_filesize is too low. A size of at least %1$s is recommended. Current value: %2$s." : "PHP upload_max_filesize je príliš nízke. Odporúčaná veľkosť je %1$s. Súčasná hodnota: %2$s.",
    "The PHP post_max_size is too low. A size of at least %1$s is recommended. Current value: %2$s." : "PHP post_max_size je príliš nízke. Odporúčaná veľkosť je %1$s. Súčasná hodnota: %2$s.",
    "The PHP max_input_time is too low. A time of at least %1$s is recommended. Current value: %2$s." : "PHP upload_input_time je príliš nízke. Odporúčaná veľkosť je %1$s. Súčasná hodnota: %2$s.",
    "The PHP max_execution_time is too low. A time of at least %1$s is recommended. Current value: %2$s." : "PHP max_execution_time je príliš nízke. Odporúčaná veľkosť je %1$s. Súčasná hodnota: %2$s.",
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 1023." : "\"%d\" nie je platný identifikátor servera. Musí byť medzi 0 a 1023.",
    "Server identifier is configured and valid." : "Identifikátor servera je nakonfigurovaný a platný.",
    ...
    "Nextcloud %d does not support your current version, so be sure to update the database before updating your Nextcloud Server." : "Nextcloud %d nepodporuje vašu aktuálnu verziu, preto sa pred aktualizáciou vášho Nextcloud Servera uistite, že ste aktualizovali databázu.",
    "Oracle version \"%1$s\" detected. Oracle >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Zistená verzia Oracle „%1$s“. Pre najlepší výkon, stabilitu a funkčnosť s touto verziou Nextcloud sa odporúča Oracle >=%2$s a <=%3$s.",
    ...
    "Task Processing pickup speed" : "Rýchlosť spracovania úloh",
    "_No scheduled tasks in the last day._::_No scheduled tasks in the last %n days._" : ["Žiadne naplánované úlohy za posledný deň.","Žiadne naplánované úlohy v posledných %n dňoch.","Žiadne naplánované úlohy v posledných %n dňoch.","Žiadne naplánované úlohy v posledných %n dňoch."],
    "_The task pickup speed has been ok in the last day._::_The task pickup speed has been ok in the last %n days._" : ["Rýchlosť preberania úloh bola v posledný deň v poriadku.","Rýchlosť prevzatia úloh bola v posledných %n dňoch v poriadku.","Rýchlosť prevzatia úloh bola v posledných %n dňoch v poriadku.","Rýchlosť prevzatia úloh bola v posledných %n dňoch v poriadku."],
    "_The task pickup speed has been slow in the last day. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._::_The task pickup speed has been slow in the last %n days. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._" : ["Rýchlosť prevzatia úloh bola v posledný deň pomalá. Mnohé úlohy trvali dlhšie ako 4 minúty, kým boli prevzaté. Zvážte nastavenie pracovníka na spracovanie úloh na pozadí.","Rýchlosť preberania úloh bola v posledných %n dňoch pomalá. Mnohé úlohy trvali dlhšie ako 4 minúty, kým boli prebrané. Zvážte nastavenie pracovníka na spracovanie úloh na pozadí.","Rýchlosť preberania úloh bola v posledných %n dňoch pomalá. Mnohé úlohy trvali dlhšie ako 4 minúty, kým boli prebrané. Zvážte nastavenie pracovníka na spracovanie úloh na pozadí.","Rýchlosť preberania úloh bola v posledných %n dňoch pomalá. Mnohé úlohy trvali dlhšie ako 4 minúty, kým boli prebrané. Zvážte nastavenie pracovníka na spracovanie úloh na pozadí."],
    "_Most tasks were successful in the last day._::_Most tasks were successful in the last %n days._" : ["Väčšina úloh bola úspešná v posledný deň.","Väčšina úloh bola úspešná v posledných %n dňoch.","Väčšina úloh bola úspešná v posledných %n dňoch.","Väčšina úloh bola úspešná v posledných %n dňoch."],
    "_A lot of tasks failed in the last day. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly._::_A lot of tasks failed in the last %n days. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly._" : ["Mnoho úloh zlyhalo v posledný deň. Zvážte kontrolu protokolu Nextcloud na chyby a preskúmanie, či boli aplikácie poskytovateľa AI správne nastavené.","V posledných %n dňoch zlyhalo mnoho úloh. Zvážte skontrolovanie logu Nextcloud pre chyby a vyšetrenie, či boli aplikácie poskytovateľa AI nastavené správne.","V posledných %n dňoch zlyhalo mnoho úloh. Zvážte skontrolovanie logu Nextcloud pre chyby a vyšetrenie, či boli aplikácie poskytovateľa AI nastavené správne.","V posledných %n dňoch zlyhalo mnoho úloh. Zvážte skontrolovanie logu Nextcloud pre chyby a vyšetrenie, či boli aplikácie poskytovateľa AI nastavené správne."],
    ...
    "Second factor configuration" : "Konfigurácia druhého faktora",
    "This instance has no second factor provider available." : "Táto inštancia nemá dostupného poskytovateľa druhého faktora.",
    "Second factor providers are available but two-factor authentication is not enforced." : "Druhá faktora je k dispozícii, ale dvojfázová autentifikácia nie je vynútená.",
    "Second factor providers are available and enforced: %s." : "Druhí poskytovatelia faktorov sú k dispozícii a vynucovaní: %s.",
    ...
    "Font file loading" : "Nahrávanie súboru písma",
    "Could not check for {extension} loading support. Please check manually if your webserver serves `.{extension}` files." : "Nepodarilo sa skontrolovať podporu načítania typu {extension}. Prosím skontrolujte manuálne, či váš webový server obsluhuje súbory typu `.{extension}`.",
    "Your web server is not properly set up to deliver .{extension} files. This is typically an issue with the Nginx configuration. For Nextcloud 15 it needs an adjustment to also deliver .{extension} files. Compare your Nginx configuration to the recommended configuration in our documentation." : "Váš webový server nie je správne nastavený na doručovanie súborov typu {extension}. Toto je zvyčajne problém s konfiguráciou Nginx. Pre Nextcloud 15 potrebuje úpravu, aby poskytoval aj .{extension} súbory. Porovnajte svoju konfiguráciu Nginx s odporúčanou konfiguráciou v našej dokumentácii.",
    ...
    "Allow AI usage for guest users" : "Povoliť používanie AI pre hostí",
    "Provider for Task types" : "Poskytovateľ typov Úloh",
    "Enable" : "Povoliť",
    ...
    "Task:" : "Úloha:",
    "None of your currently installed apps provide text processing functionality using the Text Processing API." : "Žiadna z vašich aktuálne nainštalovaných aplikácií neposkytuje funkcie spracovania textu pomocou rozhrania API na spracovanie textu.",
    ...
    "Allow apps to use the Share API" : "Povoliť aplikáciám používať API pre zdieľanie",
    "Allow resharing" : "Povoliť zdieľanie ďalej",
    "Allow sharing with groups" : "Povoliť zdieľanie so skupinami",
    "Restrict users to only share with users in their groups" : "Povoliť užívateľom zdieľanie obsahu len v rámci ich skupiny",
    "Ignore the following groups when checking group membership" : "Ignorovať nasledujúce skupiny pri kontrole členstva v skupine.",
    "Allow users to preview files even if download is disabled" : "Povoliť používateľom náhľad súborov, aj keď je stiahnutie zakázané.",
    "Users will still be able to screenshot or record the screen. This does not provide any definitive protection." : "Používatelia budú aj naďalej schopní robiť snímky obrazovky alebo nahrávať obrazovku. Toto neposkytuje žiadnu definitívnu ochranu.",
    "Allow users to share via link and emails" : "Povoliť užívateľom zdieľanie obsahu pomocou odkazov",
    "Allow public uploads" : "Povoliť verejné nahrávanie súborov",
    "Allow public shares to be added to other clouds by federation." : "Povoliť pridanie verejných zdieľaní do iných cloudov prostredníctvom federácie.",
    "This will add share permissions to all newly created link shares." : "Týmto sa pridajú oprávnenia na zdieľanie ku všetkým novovytvoreným zdieľaniam prostredníctvom odkazu.",
    ...
    "Exclude some groups" : "Vylúčiť niektoré skupiny",
    "Allow some groups" : "Povoliť niektoré skupiny",
    ...
    "Set default expiration date for internal shares" : "Nastaviť predvolený dátum skončenia platnosti pre interné zdieľania",
    ...
    "Enforce expiration date for link or mail shares" : "Vynútiť dátum expirácie pre zdieľania odkazov alebo e-mailov",
    ...
    "Sharing autocompletion restrictions" : "Zdieľanie obmedzení automatického dopĺňania",
    "If autocompletion restrictions for both \"same group\" and \"phonebook integration\" are enabled, a match in either is enough to show the user." : "Ak sú obmedzenia automatického dopĺňania pre \"rovnakú skupinu\" a \"integráciu s telefónnym zoznamom\" povolené, zodpovedajúca zhoda v ktoromkoľvek z týchto polí je dostatočná na zobrazenie používateľovi.",
    ...
    "Restrict account name autocompletion to users based on their phonebook" : "Obmedziť automatické dopĺňanie názvov účtov pre používateľov na základe ich telefónneho zoznamu.",
    "Allow autocompletion to full match when entering the full name (ignoring restrictions like group membership or missing phonebook match)" : "Povoľte automatické dopĺňanie pre úplné zodpovedanie pri zadávaní celého mena (ignorujte obmedzenia, ako je členstvo v skupine alebo chýbajúce zhodu v telefónnom zozname).",
    "Full match autocompletion restrictions" : "Obmedzenia automatického dopĺňania celých zápasov",
    "Also allow autocompletion on full match of the user ID" : "Tiež povoľte automatické dopĺňanie pri úplnom zhodovaní používateľského ID.",
    "Also allow autocompletion on full match of the display name" : "Povoľte aj automatické dopĺňanie pri úplnej zhode zobrazeného názvu.",
    "Also allow autocompletion on full match of the user email" : "Taktiež povoľte automatické dopĺňanie pri úplnej zhode emailu používateľa.",
    "Do not use second user displayname for full match" : "Nepoužívať zobrazované meno druhého používateľa pri úplnej zhode",
    ...
    "Select your preferred office suite. Please note that installing requires manual server setup." : "Vyberte si preferovaný kancelársky balík. Upozorňujeme, že inštalácia si vyžaduje manuálne nastavenie servera.",
    ...
    "All office suites disabled" : "Všetky kancelárske balíky sú zakázané",
    "{name} enabled" : "{name} zapnuté",
    ...
    "List of groups. This list is not fully populated for performance reasons. The groups will be loaded as you navigate or search through the list." : "Zoznam skupín. Tento zoznam nie je úplne vykreslený z dôvodov výkonu. Skupiny budú vykreslené, keď budete prechádzať zoznamom.",
    ...
    "Enable or disable the profile picker in the Smart Picker and the profile link previews." : "Povoliť alebo zakázať výber profilu v Smart Picker a náhľady odkazov na profily.",
    ...
    "To encrypt all existing files run this OCC command:" : "Ak chcete zašifrovať všetky existujúce súbory, spustite tento príkaz OCC:",
    "Enable server-side encryption" : "Povoliť šifrovanie na serveri",
    "Disabling server side encryption is only possible using OCC, please refer to the documentation." : "Zakázanie šifrovania na strane servera je možné iba pomocou OCC, pozrite si dokumentáciu.",
    ...
    "Cancel encryption" : "Zrušiť šifrovanie",
    "Enable encryption" : "Povoliť šifrovanie",
    "Confirm enabling encryption" : "Potvrďte povolenie šifrovania",
    ...
    "Failed to delete group \"{group}\"" : "Nepodarilo sa odstrániť skupinu \"{group}\"",
    "Please confirm the group removal" : "Prosím potvrďte vymazanie skupiny.",
    "You are about to delete the group \"{group}\". The accounts will NOT be deleted." : "Chystáte sa vymazať skupinu \"{group}\". Účty NEBUDÚ vymazané.",
    "Submit" : "Odoslať",
    ...
    "he/him" : "on/jeho",
    "they/them" : "oni/ich",
    "Your pronouns. E.g. {pronounsExample}" : "Vaše zámená. Napr. {pronounsExample}",
    "Your role" : "Vaša rola",
    ...
    "Default config values" : "Predvolené hodnoty konfigurácie",
    "Applications config" : "Konfigurácia aplikácií",
    "User config" : "Používateľská konfigurácia",
    "Bundled applications" : "Zlúčené aplikácie",
    "Enabled applications" : "Povolené aplikácie",
    "Disabled applications" : "Zakázané aplikácie",
    "Large organization" : "Veľká organizácia",
    "Big organization" : "Veľká organizácia",
    "Small organization" : "Malá organizácia",
    "Hosting company" : "Hostingová spoločnosť",
    "University" : "Univerzita",
    "School" : "Škola",
    "Club or association" : "Klub alebo združenie",
    "Family" : "Rodina",
    "Personal use" : "Osobné použitie",
    "Setup errors" : "Chyby nastavenia",
    "Setup warnings" : "Varovania pri nastavení",
    "Setup recommendations" : "Odporúčania pre nastavenie",
    ...
    "Loading accounts …" : "Načítavanie účtov …",
    ...
    "_{userCount} account …_::_{userCount} accounts …_" : ["{userCount} účet ...","{userCount} účtov ...","{userCount} účtov ...","{userCount} účty ..."],
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the {productName} data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "V prípade straty zariadenia alebo odchodu z organizácie môže tento proces vzdialene vymazať údaje {productName} zo všetkých zariadení spojených s {userid}. Funguje iba v prípade, že zariadenia sú pripojené k internetu.",
    ...
    "Failed to load sub admin groups with details" : "Nepodarilo sa načítať podskupiny administrátorov s detailmi.",
    ...
    "Loading account …" : "Načítavanie účtu …",
    ...
    "Email sent successfully" : "Email bol úspešne odoslaný",
    "Failed to send email" : "Nepodarilo sa odoslať e-mail",
    "Failed to save email settings" : "Nepodarilo sa uložiť nastavenia e-mailu",
    ...
    "The server configuration is read-only so the mail settings cannot be changed using the web interface." : "Konfigurácia servera je iba na čítanie, takže nastavenia pošty nemôžu byť zmenené pomocou webového rozhrania.",
    "Mail delivery is disabled by instance config \"{config}\"." : "Doručovanie pošty je deaktivované nastavením inštancie. \"{config}\".",
    ...
    "Sending test email…" : "Odosielanie testovacieho emailu…",
    "Send test email" : "Odoslať testovací email",
    "Saving…" : "Ukladanie...",
    "Save settings" : "Uložiť nastavenia",
    "Please double check the {linkStartInstallationGuides}installation guides{linkEnd}, and check for any errors or warnings in the {linkStartLog}log{linkEnd}." : "Prosím, dôkladne skontrolujte {linkStartInstallationGuides}inštalačné príručky{linkEnd} a skontrolujte, či sa v {linkStartLog}zázname{linkEnd} nenachádzajú žiadne chyby alebo varovania.",
    "Check the security of your {productName} over {linkStart}our security scan{linkEnd}." : "Skontrolujte bezpečnosť vášho {productName} cez {linkStart}náš bezpečnostný skener{linkEnd}.",
    "Security & setup warnings" : "Bezpečnosť a nastavenia upozornení",
    "It is important for the security and performance of your instance that everything is configured correctly. To help you with that we are doing some automatic checks. Please see the linked documentation for more information." : "Je dôležité, aby bola vaša inštancia správne nakonfigurovaná pre jej bezpečnosť a výkon. Aby sme vám s tým pomohli, vykonávame niektoré automatické kontroly. Pre viac informácií si pozrite prepojenú dokumentáciu.",
    "Checking your server …" : "Kontrola vášho servera …",
    "Failed to run setup checks" : "Nepodarilo sa spustiť kontrolu nastavení",
    ...
    "Failed to save selected preset." : "Nepodarilo sa uložiť vybraný prednastavený režim.",
    "Select a configuration preset for easy setup." : "Vyberte prednastavenú konfiguráciu pre jednoduché nastavenie.",
    "Apply" : "Použiť",
    "All accounts" : "Všetky účty",
    "Admins" : "Administrátori",
    "Account group: {group}" : "Skupina účtu: {group}",
    "Account management" : "Správa účtu",
    "For performance reasons, when you enable encryption on a {productName} server only new and changed files are encrypted." : "Z dôvodov výkonu, keď povolíte šifrovanie na serveri {productName}, šifrujú sa iba nové a zmenené súbory.",
    "Location" : "Miesto",
    ...
    "This app is not marked as compatible with your {productName} version." : "Táto aplikácia nie je označená ako kompatibilná s vašou verziou {productName}.",
    "If you continue you will still be able to install the app. Note that the app might not work as expected." : "Ak budete pokračovať, aplikáciu stále budete môcť nainštalovať. Majte na pamäti, že aplikácia nemusí fungovať podľa očakávaní.",
    "Unknown" : "Neznámy",
    "Never" : "Nikdy",
    ...
    "Follow us on Bluesky" : "Sledujte nás na Bluesky",
