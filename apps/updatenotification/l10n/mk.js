OC.L10N.register(
    ...
    "App updated" : "Ажурирана е апликација",
    "See what's new" : "Што е ново",
    "{app} updated to version {version}" : "{app} ажурирана на верзија {version}",
    ...
    "Please note that the web updater is not recommended with more than 100 accounts! Please use the command line updater instead!" : "Имајте на ум дека веб ажурирачот не е препорачан за повеќе од 100 корисници! Наместо тоа, користете го ажурирачот на командната линија!",
    "Open updater" : "Стартувај го надградувачот",
    "Download now" : "Преземи",
    "Web updater is disabled. Please use the command line updater or the appropriate update mechanism for your installation method (e.g. Docker pull) to update." : "Веб-ажурирањето е оневозможено. Користете го ажурирањето од командната линија или соодветниот механизам за ажурирање за вашиот метод на инсталација (на пр. Docker pull) за ажурирање.",
    ...
    "Current update channel:" : "Моментален канал за ажурирање:",
