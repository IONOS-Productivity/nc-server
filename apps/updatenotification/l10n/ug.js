OC.L10N.register(
    ...
    "Configuration is read-only" : "سەپلىمە بولسا ئوقۇشقىلا-بولىدىغان",
    ...
    "Web updater is disabled. Please use the command line updater or the appropriate update mechanism for your installation method (e.g. Docker pull) to update." : "تور يېڭىلاش ئىقتىدارى چەكلەنگەن. يېڭىلاش ئۈچۈن بۇيرۇق قۇرىنى يېڭىلاش ياكى قاچىلاش ئۇسۇلىڭىزغا ماس كېلىدىغان يېڭىلاش مېخانىزمىنى (مەسىلەن Docker pull) ئىشلىتىڭ.",
