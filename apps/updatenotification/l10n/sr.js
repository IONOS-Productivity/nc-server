OC.L10N.register(
    ...
    "Configuration is read-only" : "Конфигурација може само да се чита",
    "App updated" : "Апликација је ажурирана",
    "See what's new" : "Погледајте шта има ново",
    "{app} updated to version {version}" : "{app} је ажурирана на верзију {version}",
    ...
    "Update channel" : "Канал ажурирања",
    "Changing the update channel also affects the apps management page. E.g. after switching to the beta channel, beta app updates will be offered to you in the apps management page." : "Промена канала ажурирања такође утиче и на страницу за управљање апликацијама. Нпр. када се пребаците на бета канал, на страници за управљање апликацијама ће вам се нудити и бета ажурирања апликација.",
    "Current update channel:" : "Тренутни канал ажурирања:",
