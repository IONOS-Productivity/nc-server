OC.L10N.register(
    ...
    "Configuration is read-only" : "A konfiguráció csak olvasható",
    "App updated" : "Alkalmazás frissítve",
    "See what's new" : "Újdonságok megtekintése",
    "{app} updated to version {version}" : "A(z) {app} frissítve lett erre a verzióra: {version}",
    ...
    "Displays update notifications for Nextcloud, app updates, and provides the SSO for the updater." : "Megjeleníti a Nextcloud és az alkalmazások frissítéseiről szóló értesítéseket, és SSO hozzáférést biztosít a frissítőhöz.",
    "Give feedback" : "Visszajelzés küldése",
    "Get started" : "Kezdő lépések",
    "No changelog available" : "Nem érhető el változásnapló",
    "What's new in {app} {version}" : "Újdonságok: {app}{version}",
    ...
    "Please note that the web updater is not recommended with more than 100 accounts! Please use the command line updater instead!" : "Vegye figyelembe, hogy a webes frissítő 100-nál több fiók esetén nem ajánlott. Használja helyette a parancssoros frissítőt.",
