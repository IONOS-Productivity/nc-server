OC.L10N.register(
    ...
    "Displays update notifications for Nextcloud, app updates, and provides the SSO for the updater." : "Zeigt Update-Benachrichtigungen für Nextcloud und App-Updates an und stellt SSO für den Updater bereit.",
    "Give feedback" : "Feedback geben",
    "Get started" : "Loslegen",
    "No changelog available" : "Keine Änderungsübersicht verfügbar",
    "What's new in {app} {version}" : "Neuigkeiten in {app} {version}",
    ...
    "Please make sure your config.php does not set <samp>appstoreenabled</samp> to false." : "Bitte sicherstellen, dass in der \"config.php\"-Datei die Variable <samp>appstoreenabled</samp> nicht auf \"false\" steht.",
    "Could not connect to the App Store or no updates have been returned at all. Search manually for updates or make sure your server has access to the internet and can connect to the App Store." : "Die Verbindung zum App-Store konnte nicht aufgebaut werden oder der App-Store hat keine Apps zurück geliefert. Selbst nach Updates suchen oder sicherstellen, dass der Server Zugriff auf das Internet hat und eine Verbindung zum App-Store aufbauen kann.",
    ...
    "The version you are running is not maintained anymore. Please make sure to update to a supported version as soon as possible." : "Die installierte Version wird nicht mehr unterstützt. Bitte baldmöglichst auf eine unterstützte Version aktualisieren.",
