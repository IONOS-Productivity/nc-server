OC.L10N.register(
    ...
    "The replacement character may only be a single character." : "替代字元僅限單一字元。",
    "Filename sanitization already started." : "檔案名稱消毒流程已開始。",
    "No filename sanitization in progress." : "目前未進行檔案名稱清理。",
    ...
    "Column headers with buttons are sortable." : "具有按鈕的直欄標題可排序。",
    ...
    "In folder" : "在資料夾中",
    "Pick folder to search in" : "請挑選要搜尋的資料夾",
