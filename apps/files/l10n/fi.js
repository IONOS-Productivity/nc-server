OC.L10N.register(
    ...
    "Keep {old}" : "Pidä {old}",
    "Keep without extension" : "Pidä ilman tiedostopäätettä",
    "Use {new}" : "Käytä {new}",
    ...
    "Add or remove favorite" : "Lisää tai poista suosikki",
    "Move" : "Siirrä",
    "Copy" : "Kopioi",
    ...
    "\"{segment}\" is a reserved name and not allowed for filenames." : "\"{segment}\" on varattu nimi, eikä se ole sallittu nimi tiedostoille.",
    ...
    "Search" : "Etsi",
    "Search results within your files." : "Hakutulokset tiedostoistasi.",
